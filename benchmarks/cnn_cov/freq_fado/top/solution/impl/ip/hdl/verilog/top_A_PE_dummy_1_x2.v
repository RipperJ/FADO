...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_PE_1_2_x221_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_PE_1_2_x221_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln890_reg_68 == 1'd0) & (fifo_A_PE_1_2_x221_empty_n == 1'b0));
end
