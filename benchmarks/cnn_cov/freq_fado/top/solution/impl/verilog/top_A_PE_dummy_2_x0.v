...
module top_A_PE_dummy_2_x0 (
        ...
        ap_idle,
        ap_ready,
        fifo_A_PE_2_2_x024_dout,
        fifo_A_PE_2_2_x024_empty_n,
        fifo_A_PE_2_2_x024_read
);
...
output   ap_idle;
output   ap_ready;
input  [255:0] fifo_A_PE_2_2_x024_dout;
input   fifo_A_PE_2_2_x024_empty_n;
output   fifo_A_PE_2_2_x024_read;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg fifo_A_PE_2_2_x024_read;
...
always @ (*) begin
    if (((icmp_ln890_reg_68 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_A_PE_2_2_x024_read = 1'b1;
    end else begin
        fifo_A_PE_2_2_x024_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_PE_2_2_x024_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_PE_2_2_x024_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln890_reg_68 == 1'd0) & (fifo_A_PE_2_2_x024_empty_n == 1'b0));
end
