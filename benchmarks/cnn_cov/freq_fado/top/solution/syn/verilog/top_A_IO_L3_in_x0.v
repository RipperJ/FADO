...
wire  signed [63:0] sext_ln108_fu_118_p1;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        p_Result_1_i_reg_179 <= {{m_axi_gmem_A_RDATA[511:256]}};
...
always @ (*) begin
    if ((icmp_ln878_fu_134_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage1)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln878_fu_134_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1)) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            end else if (((icmp_ln878_fu_134_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln878_reg_170 == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = (((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_local_out_full_n == 1'b0)) | ((icmp_ln878_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (m_axi_gmem_A_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_local_out_full_n == 1'b0)) | ((icmp_ln878_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (m_axi_gmem_A_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_local_out_full_n == 1'b0)) | ((icmp_ln878_reg_170 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (m_axi_gmem_A_RVALID == 1'b0)));
end
...
always @ (*) begin
    ap_block_state73_pp0_stage1_iter0 = ((icmp_ln878_reg_170 == 1'd0) & (m_axi_gmem_A_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter1 = ((icmp_ln878_reg_170 == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state75_pp0_stage1_iter1 = ((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

always @ (*) begin
    ap_condition_763 = ((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln878_reg_170 == 1'd0) & (1'b0 == ap_block_pp0_stage0_01001));
end

always @ (*) begin
    ap_condition_767 = ((icmp_ln878_reg_170_pp0_iter1_reg == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_01001));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign i_V_9_fu_128_p2 = (ap_phi_mux_i_V_phi_fu_101_p4 + 12'd1);

assign icmp_ln878_fu_134_p2 = ((ap_phi_mux_i_V_phi_fu_101_p4 == 12'd2048) ? 1'b1 : 1'b0);

assign m_axi_gmem_A_ARADDR = sext_ln108_fu_118_p1;
...
assign sext_ln108_fu_118_p1 = $signed(trunc_ln_reg_154);

assign trunc_ln674_fu_140_p1 = m_axi_gmem_A_RDATA[255:0];
