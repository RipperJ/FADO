...
attribute shreg_extract : string;
    ...
    signal i_V_3_fu_183_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_3_reg_271 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal v2_V_1981_reg_297 : STD_LOGIC_VECTOR (63 downto 0);
    signal v2_V_1982_reg_302 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal v2_V_1983_reg_307 : STD_LOGIC_VECTOR (63 downto 0);
    signal v2_V_1984_reg_312 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal v2_V_1985_reg_317 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal icmp_ln5357_fu_189_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln5357_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln5357_fu_189_p2 = ap_const_lv1_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_C_drain_C_drain_IO_L2_out_0_x0135_empty_n, ap_CS_fsm_state4, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln5357_fu_189_p2, icmp_ln878_fu_205_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln5357_fu_189_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    C_d0 <= (((((((mem_data_split_V_q1 & mem_data_split_V_q0) & v2_V_1985_reg_317) & v2_V_1984_reg_312) & v2_V_1983_reg_307) & v2_V_1982_reg_302) & v2_V_1981_reg_297) & v2_V_reg_292);
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln5357_fu_189_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln5357_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln5357_fu_189_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln5357_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    i_V_3_fu_183_p2 <= std_logic_vector(unsigned(i_V_reg_160) + unsigned(ap_const_lv12_1));
    icmp_ln5357_fu_189_p2 <= "1" when (i_V_reg_160 = ap_const_lv12_800) else "0";
    ...
    mem_data_split_V_ce0_assign_proc : process(fifo_C_drain_C_drain_IO_L2_out_0_x0135_empty_n, ap_CS_fsm_state4, ap_CS_fsm_state3, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state7) or (ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5) or (ap_const_logic_1 = ap_CS_fsm_state3) or ((fifo_C_drain_C_drain_IO_L2_out_0_x0135_empty_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
