...
attribute shreg_extract : string;
    ...
    signal icmp_ln878_fu_174_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal B_blk_n : STD_LOGIC;
    signal trunc_ln_reg_199 : STD_LOGIC_VECTOR (57 downto 0);
    signal i_V_6_fu_156_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_6_reg_210 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal sext_ln741_fu_146_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal r_fu_185_p4 : STD_LOGIC_VECTOR (255 downto 0);
    signal icmp_ln741_fu_162_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln741_fu_162_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((icmp_ln878_fu_174_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_fu_174_p2 = ap_const_lv1_1))) then 
                i_V_reg_105 <= i_V_6_reg_210;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((icmp_ln878_fu_174_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_fu_174_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state73)) then
                mem_data_V_reg_218 <= m_axi_gmem_B_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_199 <= B_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_B_ARREADY, m_axi_gmem_B_RVALID, fifo_B_local_out_full_n, B_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state73, ap_CS_fsm_state75, icmp_ln878_fu_174_p2, ap_CS_fsm_state72, icmp_ln741_fu_162_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state72 => 
                if (((icmp_ln741_fu_162_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_block_state75_assign_proc : process(fifo_B_local_out_full_n, icmp_ln878_fu_174_p2)
    begin
                ap_block_state75 <= ((icmp_ln878_fu_174_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state72, icmp_ln741_fu_162_p2)
    begin
        if (((icmp_ln741_fu_162_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state72, icmp_ln741_fu_162_p2)
    begin
        if (((icmp_ln741_fu_162_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    fifo_B_local_out_blk_n_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_fu_174_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_fu_174_p2 = ap_const_lv1_0))) then 
    ...
    fifo_B_local_out_din <= p_Val2_s_reg_127(256 - 1 downto 0);

    fifo_B_local_out_write_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_fu_174_p2)
    begin
        if ((not(((icmp_ln878_fu_174_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_fu_174_p2 = ap_const_lv1_0))) then 
    ...
    i_V_6_fu_156_p2 <= std_logic_vector(unsigned(i_V_reg_105) + unsigned(ap_const_lv12_1));
    icmp_ln741_fu_162_p2 <= "1" when (i_V_reg_105 = ap_const_lv12_800) else "0";
    icmp_ln878_fu_174_p2 <= "1" when (p_V_reg_116 = ap_const_lv2_2) else "0";
    m_axi_gmem_B_ARADDR <= sext_ln741_fu_146_p1;
    m_axi_gmem_B_ARBURST <= ap_const_lv2_0;
    m_axi_gmem_B_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem_B_ARID <= ap_const_lv1_0;
    m_axi_gmem_B_ARLEN <= ap_const_lv32_800;
    ...
    r_fu_185_p4 <= p_Val2_s_reg_127(511 downto 256);
        sext_ln741_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_199),64));
