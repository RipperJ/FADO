...
attribute shreg_extract : string;
    signal kernel3_x0_entry49_U0_ap_start : STD_LOGIC;
    signal kernel3_x0_entry49_U0_ap_done : STD_LOGIC;
    signal kernel3_x0_entry49_U0_ap_continue : STD_LOGIC;
    signal kernel3_x0_entry49_U0_ap_idle : STD_LOGIC;
    signal kernel3_x0_entry49_U0_ap_ready : STD_LOGIC;
    signal kernel3_x0_entry49_U0_A_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel3_x0_entry49_U0_A_out_write : STD_LOGIC;
    signal kernel3_x0_entry49_U0_B_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel3_x0_entry49_U0_B_out_write : STD_LOGIC;
    ...
    signal ap_sync_reg_kernel3_x0_entry49_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_kernel3_x0_entry49_U0_ap_ready : STD_LOGIC;
    ...
    component top_kernel3_x0_entry49 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    kernel3_x0_entry49_U0 : component top_kernel3_x0_entry49
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => kernel3_x0_entry49_U0_ap_start,
        ap_done => kernel3_x0_entry49_U0_ap_done,
        ap_continue => kernel3_x0_entry49_U0_ap_continue,
        ap_idle => kernel3_x0_entry49_U0_ap_idle,
        ap_ready => kernel3_x0_entry49_U0_ap_ready,
        A => A,
        B => B,
    ...
    ap_sync_reg_kernel3_x0_entry49_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel3_x0_entry49_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_kernel3_x0_entry49_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_sync_kernel3_x0_entry49_U0_ap_ready <= (kernel3_x0_entry49_U0_ap_ready or ap_sync_reg_kernel3_x0_entry49_U0_ap_ready);
    ap_sync_ready <= (ap_sync_kernel3_x0_entry49_U0_ap_ready and ap_sync_B_IO_L3_in_x0_U0_ap_ready and ap_sync_A_IO_L3_in_x0_U0_ap_ready);
    kernel3_x0_entry49_U0_ap_continue <= ap_const_logic_1;
    kernel3_x0_entry49_U0_ap_start <= ((ap_sync_reg_kernel3_x0_entry49_U0_ap_ready xor ap_const_logic_1) and ap_start);
    m_axi_gmem_A_ARADDR <= A_IO_L3_in_x0_U0_m_axi_gmem_A_ARADDR;
    m_axi_gmem_A_ARBURST <= A_IO_L3_in_x0_U0_m_axi_gmem_A_ARBURST;
    m_axi_gmem_A_ARCACHE <= A_IO_L3_in_x0_U0_m_axi_gmem_A_ARCACHE;
    m_axi_gmem_A_ARID <= A_IO_L3_in_x0_U0_m_axi_gmem_A_ARID;
