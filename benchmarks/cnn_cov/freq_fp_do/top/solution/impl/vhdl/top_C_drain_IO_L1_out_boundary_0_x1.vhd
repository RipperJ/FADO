...
attribute shreg_extract : string;
    ...
    signal select_ln890_346_fu_252_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal select_ln890_346_reg_396 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal add_ln691_405_fu_301_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_405_reg_417 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_state4_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_state7_pp0_stage2_iter1 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal add_ln691_406_fu_319_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_406_reg_422 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal add_ln691_407_fu_343_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln691_407_reg_435 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal icmp_ln890_301_fu_363_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal c6_V_83_reg_209 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln890_300_fu_337_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln11616_fu_280_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal zext_ln890_fu_306_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln11642_1_fu_358_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal trunc_ln674_fu_285_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln890_299_fu_238_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_fu_232_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_s_fu_274_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal trunc_ln11642_fu_325_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln11642_fu_349_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln11642_fu_353_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln890_300_fu_337_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_301_fu_363_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
                c5_V_reg_198 <= add_ln691_406_reg_422;
            end if; 
        end if;
    end process;

    c6_V_83_reg_209_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_300_fu_337_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
                c6_V_83_reg_209 <= ap_const_lv6_0;
            elsif (((fifo_C_drain_C_drain_IO_L1_out_0_12_x1121_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then 
                c6_V_83_reg_209 <= add_ln691_407_reg_435;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                c6_V_reg_176 <= select_ln890_346_reg_396;
            elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                c7_V_reg_187 <= add_ln691_405_reg_417;
            elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
                add_ln691_405_reg_417 <= add_ln691_405_fu_301_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then
                add_ln691_406_reg_422 <= add_ln691_406_fu_319_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                add_ln691_407_reg_435 <= add_ln691_407_fu_343_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_fu_226_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                conv_i106_mid2_v_reg_401 <= select_ln890_346_fu_252_p3(5 downto 1);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                local_C_V_addr_reg_411 <= zext_ln11616_fu_280_p1(9 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state9 => 
                if (((icmp_ln890_300_fu_337_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state10;
                end if;
            when ap_ST_fsm_state10 => 
                if (((icmp_ln890_301_fu_363_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
                    ap_NS_fsm <= ap_ST_fsm_state9;
                else
    ...
    add_ln11642_fu_353_p2 <= std_logic_vector(unsigned(tmp_cast_reg_427) + unsigned(zext_ln11642_fu_349_p1));
    add_ln691_405_fu_301_p2 <= std_logic_vector(unsigned(select_ln890_reg_390) + unsigned(ap_const_lv5_1));
    add_ln691_406_fu_319_p2 <= std_logic_vector(unsigned(c5_V_reg_198) + unsigned(ap_const_lv5_1));
    add_ln691_407_fu_343_p2 <= std_logic_vector(unsigned(c6_V_83_reg_209) + unsigned(ap_const_lv6_1));
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state9, icmp_ln890_300_fu_337_p2)
    begin
        if (((icmp_ln890_300_fu_337_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
    ...
    ap_phi_mux_c6_V_phi_fu_180_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln890_reg_386, c6_V_reg_176, select_ln890_346_reg_396)
    begin
        if (((icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_c6_V_phi_fu_180_p4 <= select_ln890_346_reg_396;
        else 
    ...
    ap_phi_mux_c7_V_phi_fu_191_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln890_reg_386, c7_V_reg_187, add_ln691_405_reg_417)
    begin
        if (((icmp_ln890_reg_386 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_c7_V_phi_fu_191_p4 <= add_ln691_405_reg_417;
        else 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state9, icmp_ln890_300_fu_337_p2)
    begin
        if (((icmp_ln890_300_fu_337_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
    ...
    icmp_ln890_299_fu_238_p2 <= "1" when (ap_phi_mux_c7_V_phi_fu_191_p4 = ap_const_lv5_10) else "0";
    icmp_ln890_300_fu_337_p2 <= "1" when (c5_V_reg_198 = ap_const_lv5_10) else "0";
    icmp_ln890_301_fu_363_p2 <= "1" when (c6_V_83_reg_209 = ap_const_lv6_20) else "0";
    icmp_ln890_fu_226_p2 <= "1" when (ap_phi_mux_indvar_flatten_phi_fu_169_p4 = ap_const_lv11_400) else "0";

    local_C_V_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_CS_fsm_state10, zext_ln11616_fu_280_p1, ap_block_pp0_stage1, zext_ln11642_1_fu_358_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
            local_C_V_address0 <= zext_ln11642_1_fu_358_p1(9 - 1 downto 0);
            ...
            local_C_V_address0 <= zext_ln11616_fu_280_p1(9 - 1 downto 0);
        else 
    ...
    select_ln890_346_fu_252_p3 <= 
        add_ln691_fu_232_p2 when (icmp_ln890_299_fu_238_p2(0) = '1') else 
        ap_phi_mux_c6_V_phi_fu_180_p4;
    select_ln890_fu_244_p3 <= 
        ap_const_lv5_0 when (icmp_ln890_299_fu_238_p2(0) = '1') else 
        ap_phi_mux_c7_V_phi_fu_191_p4;
    tmp_cast_fu_329_p3 <= (trunc_ln11642_fu_325_p1 & ap_const_lv5_0);
    tmp_s_fu_274_p3 <= (select_ln890_reg_390 & conv_i106_mid2_v_reg_401);
    trunc_ln11642_fu_325_p1 <= c5_V_reg_198(4 - 1 downto 0);
    trunc_ln674_fu_285_p1 <= local_C_V_q0(32 - 1 downto 0);
    trunc_ln890_fu_270_p1 <= select_ln890_346_fu_252_p3(1 - 1 downto 0);
    zext_ln11616_fu_280_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_274_p3),64));
    zext_ln11642_1_fu_358_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln11642_fu_353_p2),64));
    zext_ln11642_fu_349_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c6_V_83_reg_209),9));
