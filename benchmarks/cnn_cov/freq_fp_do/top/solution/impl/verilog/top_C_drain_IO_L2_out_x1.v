...
wire   [13:0] add_ln890_132_fu_110_p2;
...
wire   [13:0] select_ln890_340_fu_168_p3;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln890_fu_116_p2 == 1'd0))) begin
        indvar_flatten11_reg_89 <= select_ln890_340_fu_168_p3;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln890_fu_116_p2 == 1'd0))) begin
        indvar_flatten31_reg_67 <= add_ln890_132_fu_110_p2;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln890_132_fu_110_p2 = (indvar_flatten31_reg_67 + 14'd1);
...
assign select_ln890_340_fu_168_p3 = ((icmp_ln89038_fu_140_p2[0:0] == 1'b1) ? 14'd1 : add_ln890_fu_162_p2);
