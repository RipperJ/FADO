...
wire   [6:0] select_ln890_344_fu_252_p3;
reg   [6:0] select_ln890_344_reg_396;
...
wire   [4:0] add_ln691_399_fu_301_p2;
reg   [4:0] add_ln691_399_reg_417;
wire    ap_CS_fsm_pp0_stage2;
wire    ap_block_state4_pp0_stage2_iter0;
wire    ap_block_state7_pp0_stage2_iter1;
wire    ap_block_pp0_stage2_11001;
wire   [4:0] add_ln691_400_fu_319_p2;
reg   [4:0] add_ln691_400_reg_422;
wire    ap_CS_fsm_state9;
wire   [8:0] tmp_cast_fu_329_p3;
reg   [8:0] tmp_cast_reg_427;
wire   [5:0] add_ln691_401_fu_343_p2;
reg   [5:0] add_ln691_401_reg_435;
...
wire   [0:0] icmp_ln890_295_fu_363_p2;
wire    ap_CS_fsm_state8;
reg   [5:0] c6_V_81_reg_209;
wire   [0:0] icmp_ln890_294_fu_337_p2;
wire   [63:0] zext_ln5257_fu_280_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln890_fu_306_p1;
wire   [63:0] zext_ln5283_1_fu_358_p1;
wire    ap_block_pp0_stage2;
wire   [31:0] trunc_ln674_fu_285_p1;
wire   [0:0] icmp_ln890_293_fu_238_p2;
wire   [6:0] add_ln691_fu_232_p2;
wire   [9:0] tmp_s_fu_274_p3;
wire   [3:0] trunc_ln5283_fu_325_p1;
wire   [8:0] zext_ln5283_fu_349_p1;
wire   [8:0] add_ln5283_fu_353_p2;
reg   [8:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln890_294_fu_337_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        c5_V_reg_198 <= 5'd0;
    end else if (((icmp_ln890_295_fu_363_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
        c5_V_reg_198 <= add_ln691_400_reg_422;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_294_fu_337_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        c6_V_81_reg_209 <= 6'd0;
    end else if (((fifo_C_drain_C_drain_IO_L1_out_1_12_x0134_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
        c6_V_81_reg_209 <= add_ln691_401_reg_435;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        c6_V_reg_176 <= select_ln890_344_reg_396;
    end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c6_V_reg_176 <= 7'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        c7_V_reg_187 <= add_ln691_399_reg_417;
    end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c7_V_reg_187 <= 5'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        add_ln691_399_reg_417 <= add_ln691_399_fu_301_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        add_ln691_400_reg_422 <= add_ln691_400_fu_319_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        add_ln691_401_reg_435 <= add_ln691_401_fu_343_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_226_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        conv_i106_mid2_v_reg_401 <= {{select_ln890_344_fu_252_p3[5:1]}};
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        local_C_V_addr_reg_411 <= zext_ln5257_fu_280_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_226_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        select_ln890_344_reg_396 <= select_ln890_344_fu_252_p3;
    end
end
...
always @ (*) begin
    if (((icmp_ln890_294_fu_337_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state9))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_c6_V_phi_fu_180_p4 = select_ln890_344_reg_396;
    end else begin
...
always @ (*) begin
    if (((icmp_ln890_reg_386 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_c7_V_phi_fu_191_p4 = add_ln691_399_reg_417;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state10 : begin
            if (((icmp_ln890_295_fu_363_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else begin
...
assign add_ln5283_fu_353_p2 = (tmp_cast_reg_427 + zext_ln5283_fu_349_p1);

assign add_ln691_399_fu_301_p2 = (select_ln890_reg_390 + 5'd1);

assign add_ln691_400_fu_319_p2 = (c5_V_reg_198 + 5'd1);

assign add_ln691_401_fu_343_p2 = (c6_V_81_reg_209 + 6'd1);
...
assign icmp_ln890_293_fu_238_p2 = ((ap_phi_mux_c7_V_phi_fu_191_p4 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_294_fu_337_p2 = ((c5_V_reg_198 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_295_fu_363_p2 = ((c6_V_81_reg_209 == 6'd32) ? 1'b1 : 1'b0);
...
assign select_ln890_344_fu_252_p3 = ((icmp_ln890_293_fu_238_p2[0:0] == 1'b1) ? add_ln691_fu_232_p2 : ap_phi_mux_c6_V_phi_fu_180_p4);

assign select_ln890_fu_244_p3 = ((icmp_ln890_293_fu_238_p2[0:0] == 1'b1) ? 5'd0 : ap_phi_mux_c7_V_phi_fu_191_p4);

assign tmp_cast_fu_329_p3 = {{trunc_ln5283_fu_325_p1}, {5'd0}};

assign tmp_s_fu_274_p3 = {{select_ln890_reg_390}, {conv_i106_mid2_v_reg_401}};

assign trunc_ln5283_fu_325_p1 = c5_V_reg_198[3:0];

assign trunc_ln674_fu_285_p1 = local_C_V_q0[31:0];

assign trunc_ln890_fu_270_p1 = select_ln890_344_fu_252_p3[0:0];

assign zext_ln5257_fu_280_p1 = tmp_s_fu_274_p3;

assign zext_ln5283_1_fu_358_p1 = add_ln5283_fu_353_p2;

assign zext_ln5283_fu_349_p1 = c6_V_81_reg_209;
