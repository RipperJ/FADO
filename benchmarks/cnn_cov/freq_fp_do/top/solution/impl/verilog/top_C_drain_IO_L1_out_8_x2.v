...
reg   [0:0] buf_data_split_V_addr_22_reg_478;
wire   [4:0] add_ln691_425_fu_318_p2;
reg   [4:0] add_ln691_425_reg_483;
wire    ap_CS_fsm_state3;
reg   [8:0] local_C_V_addr_reg_488;
wire   [1:0] add_ln691_426_fu_342_p2;
reg    ap_block_state5;
wire   [63:0] zext_ln1497_fu_374_p1;
wire   [0:0] cmp_i_i_fu_393_p2;
reg   [0:0] cmp_i_i_reg_513;
wire    ap_CS_fsm_state8;
wire   [0:0] icmp_ln890_315_fu_387_p2;
wire   [4:0] add_ln691_427_fu_399_p2;
reg   [4:0] add_ln691_427_reg_517;
wire    ap_CS_fsm_state9;
wire   [8:0] tmp_260_cast_fu_409_p3;
reg   [8:0] tmp_260_cast_reg_522;
wire   [3:0] add_ln691_424_fu_423_p2;
wire   [0:0] icmp_ln890_317_fu_417_p2;
wire   [5:0] add_ln691_428_fu_429_p2;
reg   [5:0] add_ln691_428_reg_535;
...
wire   [0:0] icmp_ln890_316_fu_336_p2;
reg    ap_block_state1;
...
wire   [0:0] icmp_ln890_318_fu_449_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_315_fu_387_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_293_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_237 <= 4'd3;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_317_fu_417_p2 == 1'd1))) begin
        c4_V_reg_237 <= add_ln691_424_fu_423_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_315_fu_387_p2 == 1'd0))) begin
        c5_V_reg_249 <= 5'd0;
    end else if (((icmp_ln890_318_fu_449_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
        c5_V_reg_249 <= add_ln691_427_reg_517;
    end
end

always @ (posedge ap_clk) begin
    if (((fifo_C_drain_C_drain_IO_L1_out_0_3_x2112_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
        c6_V_87_reg_260 <= add_ln691_428_reg_535;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_317_fu_417_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c6_V_reg_195 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_316_fu_336_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_293_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        c7_V_reg_206 <= add_ln691_425_reg_483;
    end
end

always @ (posedge ap_clk) begin
    if (((fifo_C_drain_C_drain_IO_L1_out_0_4_x2113_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
        fifo_data_9_reg_271 <= fifo_C_drain_C_drain_IO_L1_out_0_4_x2113_dout;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        n_V_reg_217 <= add_ln691_426_fu_342_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_425_reg_483 <= add_ln691_425_fu_318_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        add_ln691_427_reg_517 <= add_ln691_427_fu_399_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        add_ln691_428_reg_535 <= add_ln691_428_fu_429_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_293_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        buf_data_split_V_addr_22_reg_478 <= idxprom_fu_313_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_315_fu_387_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        buf_data_split_V_address0 = buf_data_split_V_addr_22_reg_478;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_316_fu_336_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_317_fu_417_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
        ...
        ap_ST_fsm_state10 : begin
            if (((icmp_ln890_318_fu_449_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if (((icmp_ln890_318_fu_449_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10) & (cmp_i_i_reg_513 == 1'd1))) begin
...
assign add_ln17173_fu_439_p2 = (tmp_260_cast_reg_522 + zext_ln17173_fu_435_p1);

assign add_ln691_424_fu_423_p2 = (c4_V_reg_237 + 4'd1);

assign add_ln691_425_fu_318_p2 = (c7_V_reg_206 + 5'd1);

assign add_ln691_426_fu_342_p2 = (n_V_reg_217 + 2'd1);

assign add_ln691_427_fu_399_p2 = (c5_V_reg_249 + 5'd1);

assign add_ln691_428_fu_429_p2 = (c6_V_87_reg_260 + 6'd1);
...
assign fifo_C_drain_C_drain_IO_L1_out_0_3_x2112_din = fifo_data_9_reg_271;

assign icmp_ln878_fu_353_p2 = ((n_V_reg_217 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln890_315_fu_387_p2 = ((c4_V_reg_237 == 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln890_316_fu_336_p2 = ((c7_V_reg_206 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_317_fu_417_p2 = ((c5_V_reg_249 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_318_fu_449_p2 = ((c6_V_87_reg_260 == 6'd32) ? 1'b1 : 1'b0);
...
assign tmp_260_cast_fu_409_p3 = {{trunc_ln17173_fu_405_p1}, {5'd0}};
...
assign zext_ln17173_fu_435_p1 = c6_V_87_reg_260;
