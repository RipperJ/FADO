...
reg   [0:0] buf_data_split_V_addr_49_reg_478;
...
wire   [0:0] icmp_ln890_349_fu_387_p2;
wire   [4:0] add_ln691_471_fu_399_p2;
reg   [4:0] add_ln691_471_reg_517;
wire    ap_CS_fsm_state9;
wire   [8:0] tmp_380_cast_fu_409_p3;
reg   [8:0] tmp_380_cast_reg_522;
wire   [3:0] add_ln691_468_fu_423_p2;
wire   [0:0] icmp_ln890_351_fu_417_p2;
...
wire   [0:0] icmp_ln890_350_fu_336_p2;
reg    ap_block_state1;
...
wire   [0:0] icmp_ln890_352_fu_449_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_349_fu_387_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_293_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_237 <= 4'd6;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_351_fu_417_p2 == 1'd1))) begin
        c4_V_reg_237 <= add_ln691_468_fu_423_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_349_fu_387_p2 == 1'd0))) begin
        c5_V_reg_249 <= 5'd0;
    end else if (((icmp_ln890_352_fu_449_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((fifo_C_drain_C_drain_IO_L1_out_0_6_x1115_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state13))) begin
        c6_V_94_reg_260 <= add_ln691_472_reg_535;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_351_fu_417_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c6_V_reg_195 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_350_fu_336_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((fifo_C_drain_C_drain_IO_L1_out_0_7_x1116_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state11))) begin
        fifo_data_16_reg_271 <= fifo_C_drain_C_drain_IO_L1_out_0_7_x1116_dout;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_380_cast_reg_522[8 : 5] <= tmp_380_cast_fu_409_p3[8 : 5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_293_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        buf_data_split_V_addr_49_reg_478 <= idxprom_fu_313_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_349_fu_387_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        ...
        buf_data_split_V_address0 = buf_data_split_V_addr_49_reg_478;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_350_fu_336_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_351_fu_417_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
        ...
        ap_ST_fsm_state10 : begin
            if (((icmp_ln890_352_fu_449_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if (((icmp_ln890_352_fu_449_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10) & (cmp_i_i_reg_513 == 1'd1))) begin
...
assign add_ln10593_fu_439_p2 = (tmp_380_cast_reg_522 + zext_ln10593_fu_435_p1);
...
assign add_ln691_472_fu_429_p2 = (c6_V_94_reg_260 + 6'd1);
...
assign fifo_C_drain_C_drain_IO_L1_out_0_6_x1115_din = fifo_data_16_reg_271;

assign icmp_ln878_fu_353_p2 = ((n_V_reg_217 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln890_349_fu_387_p2 = ((c4_V_reg_237 == 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln890_350_fu_336_p2 = ((c7_V_reg_206 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_351_fu_417_p2 = ((c5_V_reg_249 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_352_fu_449_p2 = ((c6_V_94_reg_260 == 6'd32) ? 1'b1 : 1'b0);
...
assign tmp_380_cast_fu_409_p3 = {{trunc_ln10593_fu_405_p1}, {5'd0}};
...
assign zext_ln10593_fu_435_p1 = c6_V_94_reg_260;
...
always @ (posedge ap_clk) begin
    tmp_380_cast_reg_522[4:0] <= 5'b00000;
end
