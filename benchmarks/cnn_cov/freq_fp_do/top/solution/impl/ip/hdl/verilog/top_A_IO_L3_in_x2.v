...
reg ap_idle;
reg ap_ready;
reg[255:0] fifo_A_A_IO_L2_in_0_x21_din;
...
reg   [11:0] i_V_reg_66;
wire   [11:0] i_V_7_fu_77_p2;
reg   [11:0] i_V_7_reg_112;
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
        if ((1'b1 == ap_condition_204)) begin
            ...
            fifo_A_A_IO_L2_in_0_x21_din = 'bx;
        end
    end else begin
        fifo_A_A_IO_L2_in_0_x21_din = 'bx;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln878_reg_117 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln878_reg_117 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln878_reg_117 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = ((icmp_ln878_reg_117_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((icmp_ln878_reg_117_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((icmp_ln878_reg_117_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln878_reg_117 == 1'd0) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage1_iter1 = ((icmp_ln878_reg_117_pp0_iter1_reg == 1'd0) & (fifo_A_A_IO_L2_in_0_x21_full_n == 1'b0));
end
