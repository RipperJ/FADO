...
module top_B_PE_dummy_1_x2 (
        ...
        ap_idle,
        ap_ready,
        fifo_B_PE_13_1_x282_dout,
        fifo_B_PE_13_1_x282_empty_n,
        fifo_B_PE_13_1_x282_read
);
...
output   ap_idle;
output   ap_ready;
input  [255:0] fifo_B_PE_13_1_x282_dout;
input   fifo_B_PE_13_1_x282_empty_n;
output   fifo_B_PE_13_1_x282_read;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg fifo_B_PE_13_1_x282_read;
...
always @ (*) begin
    if (((icmp_ln890_reg_68 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_B_PE_13_1_x282_read = 1'b1;
    end else begin
        fifo_B_PE_13_1_x282_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_B_PE_13_1_x282_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln890_reg_68 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_B_PE_13_1_x282_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((icmp_ln890_reg_68 == 1'd0) & (fifo_B_PE_13_1_x282_empty_n == 1'b0));
end
