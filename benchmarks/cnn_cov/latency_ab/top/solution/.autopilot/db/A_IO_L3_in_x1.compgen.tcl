...
set id 501
set name top_add_2ns_2ns_2_1_1
set corename simcore_add
set op add
set stage_num 1
set max_latency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 12 vector } A_ce0 { O 1 bit } A_q0 { I 503 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_A_A_IO_L2_in_0_x11_din { O 256 vector } fifo_A_A_IO_L2_in_0_x11_full_n { I 1 bit } fifo_A_A_IO_L2_in_0_x11_write { O 1 bit } } \
} "
}
