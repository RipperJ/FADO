...
wire   [0:0] icmp_ln878_81_fu_174_p2;
reg    A_blk_n;
reg   [57:0] trunc_ln_reg_199;
wire   [11:0] i_V_9_fu_156_p2;
reg   [11:0] i_V_9_reg_210;
wire    ap_CS_fsm_state72;
reg   [511:0] mem_data_V_reg_218;
wire   [1:0] add_ln691_fu_168_p2;
reg    ap_block_state75;
wire   [511:0] zext_ln1497_fu_195_p1;
reg   [11:0] i_V_reg_105;
wire    ap_CS_fsm_state71;
reg   [1:0] p_V_reg_116;
wire    ap_CS_fsm_state74;
reg   [511:0] p_Val2_s_reg_127;
wire  signed [63:0] sext_ln108_fu_146_p1;
reg    ap_block_state1;
wire   [255:0] r_fu_185_p4;
wire   [0:0] icmp_ln878_fu_162_p2;
reg   [74:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln878_fu_162_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state72))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln878_81_fu_174_p2 == 1'd0) & (fifo_A_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_81_fu_174_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state74)) begin
        p_V_reg_116 <= 2'd0;
    end else if ((~((icmp_ln878_81_fu_174_p2 == 1'd0) & (fifo_A_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_81_fu_174_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln878_fu_162_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state72))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state75) & (icmp_ln878_81_fu_174_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((~((icmp_ln878_81_fu_174_p2 == 1'd0) & (fifo_A_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_81_fu_174_p2 == 1'd0))) begin
...
assign add_ln691_fu_168_p2 = (p_V_reg_116 + 2'd1);
...
always @ (*) begin
    ap_block_state75 = ((icmp_ln878_81_fu_174_p2 == 1'd0) & (fifo_A_local_out_full_n == 1'b0));
end

assign fifo_A_local_out_din = p_Val2_s_reg_127[255:0];

assign i_V_9_fu_156_p2 = (i_V_reg_105 + 12'd1);

assign icmp_ln878_81_fu_174_p2 = ((p_V_reg_116 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln878_fu_162_p2 = ((i_V_reg_105 == 12'd2048) ? 1'b1 : 1'b0);

assign m_axi_gmem_A_ARADDR = sext_ln108_fu_146_p1;
...
assign m_axi_gmem_A_ARLEN = 32'd2048;
...
assign r_fu_185_p4 = {{p_Val2_s_reg_127[511:256]}};

assign sext_ln108_fu_146_p1 = $signed(trunc_ln_reg_199);

assign zext_ln1497_fu_195_p1 = r_fu_185_p4;
