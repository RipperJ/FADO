...
wire   [4:0] add_ln691_1178_fu_208_p2;
reg   [4:0] add_ln691_1178_reg_333;
wire    ap_CS_fsm_state3;
wire   [8:0] tmp_547_cast_fu_218_p3;
reg   [8:0] tmp_547_cast_reg_338;
wire   [3:0] add_ln691_fu_232_p2;
wire   [0:0] icmp_ln890_942_fu_226_p2;
wire   [5:0] add_ln691_1181_fu_238_p2;
reg   [5:0] add_ln691_1181_reg_351;
wire    ap_CS_fsm_state4;
reg   [8:0] local_A_pong_V_addr_reg_356;
wire   [5:0] add_ln691_1177_fu_264_p2;
reg   [5:0] add_ln691_1177_reg_364;
wire    ap_CS_fsm_state6;
wire   [8:0] zext_ln890_fu_270_p1;
reg   [8:0] zext_ln890_reg_369;
wire   [6:0] add_ln691_1179_fu_280_p2;
reg   [6:0] add_ln691_1179_reg_377;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_1180_fu_292_p2;
reg   [4:0] add_ln691_1180_reg_385;
...
wire   [0:0] icmp_ln890_944_fu_258_p2;
reg   [5:0] c5_V_30_reg_152;
reg    ap_block_state5;
reg   [5:0] c5_V_reg_163;
wire   [0:0] icmp_ln890_943_fu_286_p2;
reg   [6:0] c6_V_reg_174;
wire   [0:0] icmp_ln890_945_fu_320_p2;
wire   [0:0] icmp_ln890_941_fu_274_p2;
reg   [4:0] c7_V_reg_185;
wire   [63:0] zext_ln288_1_fu_253_p1;
wire   [63:0] zext_ln305_fu_315_p1;
wire   [3:0] trunc_ln288_fu_214_p1;
wire   [8:0] zext_ln288_fu_244_p1;
wire   [8:0] add_ln288_fu_248_p2;
wire   [3:0] trunc_ln305_fu_298_p1;
wire   [8:0] tmp_cast_fu_302_p3;
wire   [8:0] add_ln305_fu_310_p2;
reg   [8:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_941_fu_274_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c3_V_reg_129 <= 4'd3;
    end else if (((icmp_ln890_942_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_196_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_141 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_944_fu_258_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln890_942_fu_226_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c5_V_30_reg_152 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_196_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c5_V_reg_163 <= 6'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_943_fu_286_p2 == 1'd1))) begin
        c5_V_reg_163 <= add_ln691_1177_reg_364;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_941_fu_274_p2 == 1'd0))) begin
        c6_V_reg_174 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_945_fu_320_p2 == 1'd1))) begin
        c6_V_reg_174 <= add_ln691_1179_reg_377;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_943_fu_286_p2 == 1'd0))) begin
        c7_V_reg_185 <= 5'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        tmp_547_cast_reg_338[8 : 5] <= tmp_547_cast_fu_218_p3[8 : 5];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        local_A_pong_V_addr_reg_356 <= zext_ln288_1_fu_253_p1;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_941_fu_274_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_942_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_944_fu_258_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_943_fu_286_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_945_fu_320_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
...
assign add_ln288_fu_248_p2 = (tmp_547_cast_reg_338 + zext_ln288_fu_244_p1);

assign add_ln305_fu_310_p2 = (tmp_cast_fu_302_p3 + zext_ln890_reg_369);

assign add_ln691_1177_fu_264_p2 = (c5_V_reg_163 + 6'd1);

assign add_ln691_1178_fu_208_p2 = (c4_V_reg_141 + 5'd1);

assign add_ln691_1179_fu_280_p2 = (c6_V_reg_174 + 7'd1);

assign add_ln691_1180_fu_292_p2 = (c7_V_reg_185 + 5'd1);

assign add_ln691_1181_fu_238_p2 = (c5_V_30_reg_152 + 6'd1);
...
assign icmp_ln890_941_fu_274_p2 = ((c5_V_reg_163 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_942_fu_226_p2 = ((c4_V_reg_141 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_943_fu_286_p2 = ((c6_V_reg_174 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln890_944_fu_258_p2 = ((c5_V_30_reg_152 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_945_fu_320_p2 = ((c7_V_reg_185 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_fu_196_p2 = ((c3_V_reg_129 == 4'd13) ? 1'b1 : 1'b0);

assign local_A_pong_V_address0 = zext_ln305_fu_315_p1;

assign tmp_547_cast_fu_218_p3 = {{trunc_ln288_fu_214_p1}, {5'd0}};

assign tmp_cast_fu_302_p3 = {{trunc_ln305_fu_298_p1}, {5'd0}};

assign trunc_ln288_fu_214_p1 = c4_V_reg_141[3:0];

assign trunc_ln305_fu_298_p1 = c7_V_reg_185[3:0];

assign zext_ln288_1_fu_253_p1 = add_ln288_fu_248_p2;

assign zext_ln288_fu_244_p1 = c5_V_30_reg_152;

assign zext_ln305_fu_315_p1 = add_ln305_fu_310_p2;

assign zext_ln890_fu_270_p1 = c5_V_reg_163;

always @ (posedge ap_clk) begin
    tmp_547_cast_reg_338[4:0] <= 5'b00000;
