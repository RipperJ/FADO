...
attribute shreg_extract : string;
    signal kernel3_x2_entry48_U0_ap_start : STD_LOGIC;
    signal kernel3_x2_entry48_U0_ap_done : STD_LOGIC;
    signal kernel3_x2_entry48_U0_ap_continue : STD_LOGIC;
    signal kernel3_x2_entry48_U0_ap_idle : STD_LOGIC;
    signal kernel3_x2_entry48_U0_ap_ready : STD_LOGIC;
    signal kernel3_x2_entry48_U0_C_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel3_x2_entry48_U0_C_out_write : STD_LOGIC;
    signal kernel3_x2_entry65_U0_ap_start : STD_LOGIC;
    signal kernel3_x2_entry65_U0_ap_done : STD_LOGIC;
    signal kernel3_x2_entry65_U0_ap_continue : STD_LOGIC;
    signal kernel3_x2_entry65_U0_ap_idle : STD_LOGIC;
    signal kernel3_x2_entry65_U0_ap_ready : STD_LOGIC;
    signal kernel3_x2_entry65_U0_C_read : STD_LOGIC;
    signal kernel3_x2_entry65_U0_C_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel3_x2_entry65_U0_C_out_write : STD_LOGIC;
    signal ap_sync_reg_kernel3_x2_entry65_U0_ap_start : STD_LOGIC := '0';
    ...
    signal ap_sync_reg_kernel3_x2_entry48_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_kernel3_x2_entry48_U0_ap_ready : STD_LOGIC;
    ...
    component top_kernel3_x2_entry48 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component top_kernel3_x2_entry65 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    kernel3_x2_entry48_U0 : component top_kernel3_x2_entry48
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => kernel3_x2_entry48_U0_ap_start,
        ap_done => kernel3_x2_entry48_U0_ap_done,
        ap_continue => kernel3_x2_entry48_U0_ap_continue,
        ap_idle => kernel3_x2_entry48_U0_ap_idle,
        ap_ready => kernel3_x2_entry48_U0_ap_ready,
        C => C,
        C_out_din => kernel3_x2_entry48_U0_C_out_din,
        C_out_full_n => C_c1_full_n,
        C_out_write => kernel3_x2_entry48_U0_C_out_write);

    kernel3_x2_entry65_U0 : component top_kernel3_x2_entry65
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => kernel3_x2_entry65_U0_ap_start,
        ap_done => kernel3_x2_entry65_U0_ap_done,
        ap_continue => kernel3_x2_entry65_U0_ap_continue,
        ap_idle => kernel3_x2_entry65_U0_ap_idle,
        ap_ready => kernel3_x2_entry65_U0_ap_ready,
        C_dout => C_c1_dout,
    ...
    ap_sync_reg_kernel3_x2_entry48_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel3_x2_entry48_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_kernel3_x2_entry48_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_kernel3_x2_entry65_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel3_x2_entry65_U0_ap_start <= ap_const_logic_0;
            else
                if ((ap_start = ap_const_logic_1)) then 
                    ap_sync_reg_kernel3_x2_entry65_U0_ap_start <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_kernel3_x2_entry48_U0_ap_ready <= (kernel3_x2_entry48_U0_ap_ready or ap_sync_reg_kernel3_x2_entry48_U0_ap_ready);
    ap_sync_ready <= (ap_sync_kernel3_x2_entry48_U0_ap_ready and ap_sync_B_IO_L3_in_x2_U0_ap_ready and ap_sync_A_IO_L3_in_x2_U0_ap_ready);
    kernel3_x2_entry48_U0_ap_continue <= ap_const_logic_1;
    kernel3_x2_entry48_U0_ap_start <= ((ap_sync_reg_kernel3_x2_entry48_U0_ap_ready xor ap_const_logic_1) and ap_start);
    kernel3_x2_entry65_U0_ap_continue <= ap_const_logic_1;
    kernel3_x2_entry65_U0_ap_start <= (ap_sync_reg_kernel3_x2_entry65_U0_ap_start or ap_start);
