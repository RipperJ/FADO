...
reg   [0:0] select_ln11715_reg_185;
...
wire   [13:0] add_ln890_131_fu_110_p2;
...
wire   [0:0] select_ln11715_fu_146_p3;
wire   [1:0] select_ln890_fu_154_p3;
wire   [13:0] select_ln890_339_fu_168_p3;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
wire   [63:0] ap_phi_reg_pp0_iter0_fifo_data_4_reg_100;
reg   [63:0] ap_phi_reg_pp0_iter1_fifo_data_4_reg_100;
reg   [63:0] ap_phi_reg_pp0_iter2_fifo_data_4_reg_100;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_151)) begin
        if (((select_ln11715_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0))) begin
            ap_phi_reg_pp0_iter2_fifo_data_4_reg_100 <= fifo_C_drain_C_drain_IO_L2_out_1_x1136_dout;
        end else if (((select_ln11715_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0))) begin
            ap_phi_reg_pp0_iter2_fifo_data_4_reg_100 <= fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln890_fu_116_p2 == 1'd0))) begin
        indvar_flatten11_reg_89 <= select_ln890_339_fu_168_p3;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln890_fu_116_p2 == 1'd0))) begin
        indvar_flatten31_reg_67 <= add_ln890_131_fu_110_p2;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln890_fu_116_p2 == 1'd0))) begin
        select_ln11715_reg_185 <= select_ln11715_fu_146_p3;
    end
end
...
always @ (*) begin
    if (((select_ln11715_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((select_ln11715_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln890_131_fu_110_p2 = (indvar_flatten31_reg_67 + 14'd1);
...
assign ap_phi_reg_pp0_iter0_fifo_data_4_reg_100 = 'bx;

always @ (*) begin
    ap_predicate_op31_read_state3 = ((select_ln11715_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0));
end

always @ (*) begin
    ap_predicate_op33_read_state3 = ((select_ln11715_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0));
end
...
assign fifo_C_drain_C_drain_IO_L2_out_0_x1135_din = ap_phi_reg_pp0_iter2_fifo_data_4_reg_100;
...
assign select_ln11715_fu_146_p3 = ((icmp_ln89038_fu_140_p2[0:0] == 1'b1) ? cmp_i_i_mid1_fu_128_p2 : cmp_i_i35_fu_134_p2);

assign select_ln890_339_fu_168_p3 = ((icmp_ln89038_fu_140_p2[0:0] == 1'b1) ? 14'd1 : add_ln890_fu_162_p2);
