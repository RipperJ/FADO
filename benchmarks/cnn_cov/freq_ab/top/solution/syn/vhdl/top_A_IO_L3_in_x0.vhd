...
attribute shreg_extract : string;
    ...
    signal icmp_ln878_reg_170 : STD_LOGIC_VECTOR (0 downto 0);
    signal fifo_A_local_out_blk_n : STD_LOGIC;
    signal ap_CS_fsm_pp0_stage0 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage0 : signal is "none";
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal icmp_ln878_reg_170_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_V_9_fu_128_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal i_V_9_reg_165 : STD_LOGIC_VECTOR (11 downto 0);
    signal ap_block_state72_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state74_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln878_fu_134_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal sext_ln108_fu_118_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_V_reg_97 <= i_V_9_reg_165;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln878_reg_170 <= icmp_ln878_fu_134_p2;
                icmp_ln878_reg_170_pp0_iter1_reg <= icmp_ln878_reg_170;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                p_Result_1_i_reg_179 <= m_axi_gmem_A_RDATA(511 downto 256);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_154 <= A_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_A_ARREADY, A_empty_n, ap_CS_fsm_state2, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, icmp_ln878_fu_134_p2, ap_block_pp0_stage0_subdone, ap_block_pp0_stage1_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((icmp_ln878_fu_134_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage1;
                elsif (((icmp_ln878_fu_134_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;

        ap_block_pp0_stage1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage1_01001_assign_proc : process(m_axi_gmem_A_RVALID, fifo_A_local_out_full_n, ap_enable_reg_pp0_iter0, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1, icmp_ln878_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_01001 <= (((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (fifo_A_local_out_full_n = ap_const_logic_0)) or ((icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (m_axi_gmem_A_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage1_11001_assign_proc : process(m_axi_gmem_A_RVALID, fifo_A_local_out_full_n, ap_enable_reg_pp0_iter0, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1, icmp_ln878_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_11001 <= (((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (fifo_A_local_out_full_n = ap_const_logic_0)) or ((icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (m_axi_gmem_A_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage1_subdone_assign_proc : process(m_axi_gmem_A_RVALID, fifo_A_local_out_full_n, ap_enable_reg_pp0_iter0, icmp_ln878_reg_170, ap_enable_reg_pp0_iter1, icmp_ln878_reg_170_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_subdone <= (((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (fifo_A_local_out_full_n = ap_const_logic_0)) or ((icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (m_axi_gmem_A_RVALID = ap_const_logic_0)));
    end process;
    ...
    ap_block_state73_pp0_stage1_iter0_assign_proc : process(m_axi_gmem_A_RVALID, icmp_ln878_reg_170)
    begin
                ap_block_state73_pp0_stage1_iter0 <= ((icmp_ln878_reg_170 = ap_const_lv1_0) and (m_axi_gmem_A_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter1_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_reg_170)
    begin
                ap_block_state74_pp0_stage0_iter1 <= ((icmp_ln878_reg_170 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;


    ap_block_state75_pp0_stage1_iter1_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_reg_170_pp0_iter1_reg)
    begin
                ap_block_state75_pp0_stage1_iter1 <= ((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;


    ap_condition_763_assign_proc : process(icmp_ln878_reg_170, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_01001)
    begin
                ap_condition_763 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_01001));
    end process;


    ap_condition_767_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln878_reg_170_pp0_iter1_reg, ap_block_pp0_stage1_01001)
    begin
                ap_condition_767 <= ((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_01001));
    end process;


    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln878_fu_134_p2)
    begin
        if ((icmp_ln878_fu_134_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_i_V_phi_fu_101_p4_assign_proc : process(icmp_ln878_reg_170, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, i_V_reg_97, i_V_9_reg_165)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_phi_mux_i_V_phi_fu_101_p4 <= i_V_9_reg_165;
        else 
    ...
    fifo_A_local_out_blk_n_assign_proc : process(fifo_A_local_out_full_n, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, icmp_ln878_reg_170, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln878_reg_170_pp0_iter1_reg)
    begin
        if ((((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0)))) then 
    ...
    fifo_A_local_out_din_assign_proc : process(ap_enable_reg_pp0_iter1, trunc_ln674_reg_174, p_Result_1_i_reg_179, ap_condition_763, ap_condition_767)
    begin
        if ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then
            if ((ap_const_boolean_1 = ap_condition_767)) then 
                fifo_A_local_out_din <= p_Result_1_i_reg_179;
            elsif ((ap_const_boolean_1 = ap_condition_763)) then 
                fifo_A_local_out_din <= trunc_ln674_reg_174;
            else 
    ...
    fifo_A_local_out_write_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln878_reg_170, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln878_reg_170_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_block_pp0_stage1_11001)
    begin
        if ((((icmp_ln878_reg_170_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001)))) then 
    ...
    gmem_A_blk_n_R_assign_proc : process(m_axi_gmem_A_RVALID, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage1, icmp_ln878_reg_170)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    i_V_9_fu_128_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_V_phi_fu_101_p4) + unsigned(ap_const_lv12_1));
    icmp_ln878_fu_134_p2 <= "1" when (ap_phi_mux_i_V_phi_fu_101_p4 = ap_const_lv12_800) else "0";
    m_axi_gmem_A_ARADDR <= sext_ln108_fu_118_p1;
    ...
    m_axi_gmem_A_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, icmp_ln878_reg_170, ap_block_pp0_stage1_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln878_reg_170 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    m_axi_gmem_A_WVALID <= ap_const_logic_0;
        sext_ln108_fu_118_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_154),64));

    trunc_ln674_fu_140_p1 <= m_axi_gmem_A_RDATA(256 - 1 downto 0);
end behav;
