...
attribute shreg_extract : string;
    ...
    signal i_V_7_fu_118_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_V_7_reg_141 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sext_ln147_fu_108_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state74) and (fifo_A_local_out_full_n = ap_const_logic_1))) then 
                i_V_reg_87 <= i_V_7_reg_141;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state73)) then
                fifo_data_reg_149 <= m_axi_gmem_A_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_130 <= A_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_A_ARREADY, m_axi_gmem_A_RVALID, fifo_A_local_out_full_n, A_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state73, ap_CS_fsm_state74, ap_CS_fsm_state72, icmp_ln878_fu_124_p2)
    begin
        case ap_CS_fsm is
    ...
    fifo_A_local_out_blk_n_assign_proc : process(fifo_A_local_out_full_n, ap_CS_fsm_state74)
    begin
    ...
    fifo_A_local_out_din <= fifo_data_reg_149;

    fifo_A_local_out_write_assign_proc : process(fifo_A_local_out_full_n, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) and (fifo_A_local_out_full_n = ap_const_logic_1))) then 
    ...
    i_V_7_fu_118_p2 <= std_logic_vector(unsigned(i_V_reg_87) + unsigned(ap_const_lv11_1));
    icmp_ln878_fu_124_p2 <= "1" when (i_V_reg_87 = ap_const_lv11_400) else "0";
    m_axi_gmem_A_ARADDR <= sext_ln147_fu_108_p1;
    ...
    m_axi_gmem_A_WVALID <= ap_const_logic_0;
        sext_ln147_fu_108_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_130),64));
