...
attribute shreg_extract : string;
    ...
    signal empty_3551_reg_497 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal empty_3550_fu_695_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    mux_83_32_1_1_U1114 : component top_mux_83_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_83_32_1_1_U1115 : component top_mux_83_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    empty_3551_reg_497_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
    ...
    empty_3550_fu_695_p2 <= std_logic_vector(unsigned(tmp_172_cast_fu_687_p3) + unsigned(zext_ln890_31_reg_1488));
    ...
    fifo_D_drain_PE_2_0_x1143_din <= empty_3551_reg_497;
    ...
    local_D_d0_assign_proc : process(ap_CS_fsm_state16, ap_CS_fsm_state5, empty_3551_reg_497)
    begin
    ...
    p_cast_fu_700_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_3550_fu_695_p2),64));
