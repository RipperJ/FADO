set moduleName kernel0_x0_entry15
set isTopModule 0
...
set C_modelName {kernel0_x0.entry15}
set C_modelType { void 0 }
set C_modelArgList {
	{ A int 64 regular {fifo 0}  }
	{ B int 64 regular {fifo 0}  }
	{ A_out int 64 regular {fifo 1}  }
	{ B_out int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "B", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "A_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "A_out", "role": "din" }} , 
 	...
 	{ "name": "B_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	A { ap_fifo {  { A_dout fifo_data 0 64 }  { A_empty_n fifo_status 0 1 }  { A_read fifo_update 1 1 } } }
	B { ap_fifo {  { B_dout fifo_data 0 64 }  { B_empty_n fifo_status 0 1 }  { B_read fifo_update 1 1 } } }
	A_out { ap_fifo {  { A_out_din fifo_data 1 64 }  { A_out_full_n fifo_status 0 1 }  { A_out_write fifo_update 1 1 } } }
	B_out { ap_fifo {  { B_out_din fifo_data 1 64 }  { B_out_full_n fifo_status 0 1 }  { B_out_write fifo_update 1 1 } } }
}
