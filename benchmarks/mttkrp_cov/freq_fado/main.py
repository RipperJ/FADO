...
if __name__ == "__main__":
    ...
    if "9" in sys.argv:
        ...
        dse_engine = DSE_mttkrp_cov(board, top_rtl_parser, slot_manager, floorplan, graph, DSE_LIB_JSON, PREFIX_REGEXS_TO_FUNC_LIBNAME, abconfig["AreaUtilizationRatio"], sub_rtl_paths)
