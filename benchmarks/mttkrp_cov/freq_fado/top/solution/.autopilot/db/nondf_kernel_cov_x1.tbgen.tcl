...
set C_modelArgList {
	{ xout int 128 regular {array 4096 { 1 3 } 1 1 }  }
	{ xin int 119 regular {array 4096 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "xout", "interface" : "memory", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ xout_q0 sc_in sc_lv 128 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "xout_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "xout", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128s_128s_128_5_1_U1089", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128ns_130ns_257_5_1_U1090", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1081625", "Max" : "1081625"}
	, {"Name" : "Interval", "Min" : "1081625", "Max" : "1081625"}
]}
...
set Spec2ImplPortList { 
	xout { ap_memory {  { xout_address0 mem_address 1 12 }  { xout_ce0 mem_ce 1 1 }  { xout_q0 mem_dout 0 128 } } }
