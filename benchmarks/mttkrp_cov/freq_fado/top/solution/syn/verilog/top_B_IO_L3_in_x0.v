...
wire   [2:0] add_ln691_1470_fu_161_p2;
reg   [2:0] add_ln691_1470_reg_240;
...
wire   [1:0] add_ln691_1472_fu_220_p2;
reg   [1:0] add_ln691_1472_reg_272;
wire    ap_CS_fsm_state6;
reg   [2:0] c0_V_reg_94;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_105;
wire   [0:0] icmp_ln1042_fu_193_p2;
wire   [0:0] icmp_ln890_fu_155_p2;
reg   [7:0] c2_V_reg_116;
wire   [0:0] icmp_ln886_fu_215_p2;
wire   [0:0] icmp_ln1045_fu_199_p2;
reg   [3:0] c3_reg_127;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_155_p2 == 1'd0))) begin
        c1_V_reg_105 <= 3'd0;
    end else if (((icmp_ln1042_fu_193_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c1_V_reg_105 <= add_ln691_1470_reg_240;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & ((icmp_ln1045_fu_199_p2 == 1'd1) | (icmp_ln886_fu_215_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln1042_fu_193_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        c3_reg_127 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln1045_fu_199_p2 == 1'd0) & (icmp_ln886_fu_215_p2 == 1'd0))) begin
        c4_V_reg_138 <= 2'd0;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln1042_fu_193_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
...
assign add_ln691_1470_fu_161_p2 = (c1_V_reg_105 + 3'd1);

assign add_ln691_1472_fu_220_p2 = (c4_V_reg_138 + 2'd1);
...
assign icmp_ln1042_fu_193_p2 = ((c2_V_reg_116 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln1045_fu_199_p2 = ((c3_reg_127 == 4'd8) ? 1'b1 : 1'b0);
