...
wire   [2:0] add_ln691_1128_fu_153_p2;
reg   [2:0] add_ln691_1128_reg_232;
wire    ap_CS_fsm_state3;
wire   [5:0] add_i_i42_cast_fu_173_p2;
reg   [5:0] add_i_i42_cast_reg_240;
wire   [0:0] icmp_ln890_1157_fu_159_p2;
wire   [3:0] c3_18_fu_185_p2;
reg   [3:0] c3_18_reg_248;
wire    ap_CS_fsm_state4;
wire   [3:0] add_ln691_1129_fu_200_p2;
reg   [3:0] add_ln691_1129_reg_256;
wire    ap_CS_fsm_state5;
wire   [4:0] add_ln691_1130_fu_212_p2;
reg   [4:0] add_ln691_1130_reg_264;
wire    ap_CS_fsm_state6;
reg   [2:0] c0_V_reg_86;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_97;
wire   [0:0] icmp_ln886_fu_195_p2;
wire   [0:0] icmp_ln3000_fu_179_p2;
wire   [0:0] icmp_ln890_fu_147_p2;
reg   [3:0] c3_reg_108;
wire   [0:0] icmp_ln890_1158_fu_206_p2;
reg   [3:0] c4_V_reg_119;
wire   [0:0] icmp_ln890_1159_fu_218_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_86 <= 3'd0;
    end else if (((icmp_ln890_1157_fu_159_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_147_p2 == 1'd0))) begin
        c1_V_reg_97 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_fu_195_p2 == 1'd1) | (icmp_ln3000_fu_179_p2 == 1'd1)))) begin
        c1_V_reg_97 <= add_ln691_1128_reg_232;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_1158_fu_206_p2 == 1'd1))) begin
        c3_reg_108 <= c3_18_reg_248;
    end else if (((icmp_ln890_1157_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c3_reg_108 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_195_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln3000_fu_179_p2 == 1'd0))) begin
        c4_V_reg_119 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1159_fu_218_p2 == 1'd1))) begin
        c4_V_reg_119 <= add_ln691_1129_reg_256;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_1158_fu_206_p2 == 1'd0))) begin
        c5_V_reg_130 <= 5'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_1157_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_1157_fu_159_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_fu_195_p2 == 1'd1) | (icmp_ln3000_fu_179_p2 == 1'd1)))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1159_fu_218_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
...
assign add_ln691_1128_fu_153_p2 = (c1_V_reg_97 + 3'd1);

assign add_ln691_1129_fu_200_p2 = (c4_V_reg_119 + 4'd1);

assign add_ln691_1130_fu_212_p2 = (c5_V_reg_130 + 5'd1);
...
assign icmp_ln3000_fu_179_p2 = ((c3_reg_108 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln886_fu_195_p2 = ((zext_ln886_fu_191_p1 > add_i_i42_cast_reg_240) ? 1'b1 : 1'b0);

assign icmp_ln890_1157_fu_159_p2 = ((c1_V_reg_97 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln890_1158_fu_206_p2 = ((c4_V_reg_119 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_1159_fu_218_p2 = ((c5_V_reg_130 == 5'd16) ? 1'b1 : 1'b0);
