...
wire   [10:0] i_V_7_fu_118_p2;
reg   [10:0] i_V_7_reg_141;
wire    ap_CS_fsm_state72;
reg   [511:0] fifo_data_reg_149;
reg   [10:0] i_V_reg_87;
wire    ap_CS_fsm_state71;
wire  signed [63:0] sext_ln147_fu_108_p1;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state74) & (fifo_A_local_out_full_n == 1'b1))) begin
...
assign fifo_A_local_out_din = fifo_data_reg_149;

assign i_V_7_fu_118_p2 = (i_V_reg_87 + 11'd1);

assign icmp_ln878_fu_124_p2 = ((i_V_reg_87 == 11'd1024) ? 1'b1 : 1'b0);

assign m_axi_gmem_A_ARADDR = sext_ln147_fu_108_p1;
...
assign sext_ln147_fu_108_p1 = $signed(trunc_ln_reg_130);
