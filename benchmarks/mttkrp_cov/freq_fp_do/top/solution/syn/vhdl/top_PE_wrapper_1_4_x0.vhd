...
attribute shreg_extract : string;
    ...
    signal empty_2364_reg_503 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal empty_2363_fu_721_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    mux_83_32_1_1_U231 : component top_mux_83_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_83_32_1_1_U232 : component top_mux_83_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    empty_2364_reg_503_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
    ...
    empty_2363_fu_721_p2 <= std_logic_vector(unsigned(tmp_217_cast_fu_713_p3) + unsigned(zext_ln890_40_reg_1518));
    ...
    fifo_D_drain_PE_1_4_x0158_din <= empty_2364_reg_503;
    ...
    local_D_d0_assign_proc : process(ap_CS_fsm_state16, ap_CS_fsm_state5, empty_2364_reg_503)
    begin
    ...
    p_cast_fu_726_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_2363_fu_721_p2),64));
