set moduleName D_drain_IO_L3_out_x1
set isTopModule 0
...
set C_modelName {D_drain_IO_L3_out_x1}
set C_modelType { void 0 }
set C_modelArgList {
	{ fifo_D_drain_out int 128 regular {fifo 1 volatile }  }
	{ fifo_D_drain_local_in int 128 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fifo_D_drain_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ fifo_D_drain_out_din sc_out sc_lv 128 signal 0 } 
	{ fifo_D_drain_out_full_n sc_in sc_logic 1 signal 0 } 
	{ fifo_D_drain_out_write sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_D_drain_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "fifo_D_drain_out", "role": "din" }} , 
 	{ "name": "fifo_D_drain_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_D_drain_out", "role": "full_n" }} , 
 	{ "name": "fifo_D_drain_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_D_drain_out", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "fifo_D_drain_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9513", "Max" : "75705"}
	, {"Name" : "Interval", "Min" : "9513", "Max" : "75705"}
]}
...
set Spec2ImplPortList { 
	fifo_D_drain_out { ap_fifo {  { fifo_D_drain_out_din fifo_data 1 128 }  { fifo_D_drain_out_full_n fifo_status 0 1 }  { fifo_D_drain_out_write fifo_update 1 1 } } }
