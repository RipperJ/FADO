; ModuleID = '/home/x/linfeng-du/Projects/MFPD/benchmarks/DSETest/AutoSA/mttkrp_cov/mttkrp_cov_auto_nofp_post/top/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_top_ir(%struct.ap_uint* %A, %struct.ap_uint* %B, %struct.ap_uint* %C, %struct.ap_uint* %D) local_unnamed_addr #0 {
entry:
  %A_copy1 = alloca %struct.ap_uint, align 512
  %B_copy2 = alloca %struct.ap_uint, align 512
  %C_copy3 = alloca %struct.ap_uint, align 512
  %D_copy4 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %A, %struct.ap_uint* nonnull align 512 %A_copy1, %struct.ap_uint* %B, %struct.ap_uint* nonnull align 512 %B_copy2, %struct.ap_uint* %C, %struct.ap_uint* nonnull align 512 %C_copy3, %struct.ap_uint* %D, %struct.ap_uint* nonnull align 512 %D_copy4)
  call void @apatb_top_hw(%struct.ap_uint* %A_copy1, %struct.ap_uint* %B_copy2, %struct.ap_uint* %C_copy3, %struct.ap_uint* %D_copy4)
  call fastcc void @copy_out(%struct.ap_uint* %A, %struct.ap_uint* nonnull align 512 %A_copy1, %struct.ap_uint* %B, %struct.ap_uint* nonnull align 512 %B_copy2, %struct.ap_uint* %C, %struct.ap_uint* nonnull align 512 %C_copy3, %struct.ap_uint* %D, %struct.ap_uint* nonnull align 512 %D_copy4)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_top_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)

define void @top_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  ...
  call void @top_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, %struct.ap_uint* %2, %struct.ap_uint* %3)
...
declare void @top_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)
