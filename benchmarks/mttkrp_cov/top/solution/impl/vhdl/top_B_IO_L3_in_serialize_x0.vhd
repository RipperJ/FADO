...
attribute shreg_extract : string;
    ...
    signal icmp_ln878_99_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((icmp_ln878_99_fu_172_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_99_fu_172_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((icmp_ln878_99_fu_172_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_99_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_B_ARREADY, m_axi_gmem_B_RVALID, fifo_B_local_out_full_n, B_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state73, ap_CS_fsm_state75, icmp_ln878_99_fu_172_p2, ap_CS_fsm_state72, icmp_ln878_fu_160_p2)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state75_assign_proc : process(fifo_B_local_out_full_n, icmp_ln878_99_fu_172_p2)
    begin
                ap_block_state75 <= ((icmp_ln878_99_fu_172_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0));
    end process;
    ...
    fifo_B_local_out_blk_n_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_99_fu_172_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_99_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    fifo_B_local_out_write_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_99_fu_172_p2)
    begin
        if ((not(((icmp_ln878_99_fu_172_p2 = ap_const_lv1_0) and (fifo_B_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_99_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln878_99_fu_172_p2 <= "1" when (p_V_reg_114 = ap_const_lv2_2) else "0";
