...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        empty_3579_reg_497 <= local_D_q0;
    end else if ((1'b1 == ap_CS_fsm_state31)) begin
        empty_3579_reg_497 <= grp_fu_508_p2;
    end
end
...
assign empty_3578_fu_695_p2 = (tmp_242_cast_fu_687_p3 + zext_ln890_45_reg_1488);
...
assign fifo_D_drain_PE_1_1_x1146_din = empty_3579_reg_497;
...
assign p_cast_fu_700_p1 = empty_3578_fu_695_p2;
