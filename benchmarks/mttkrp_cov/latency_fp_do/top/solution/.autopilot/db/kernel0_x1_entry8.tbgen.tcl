set moduleName kernel0_x1_entry8
set isTopModule 0
...
set C_modelName {kernel0_x1.entry8}
set C_modelType { void 0 }
set C_modelArgList {
	{ C int 64 regular  }
	{ D int 64 regular  }
	{ C_out int 64 regular {fifo 1}  }
	{ D_out int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "D_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ D sc_in sc_lv 64 signal 1 } 
	{ C_out_din sc_out sc_lv 64 signal 2 } 
	{ C_out_full_n sc_in sc_logic 1 signal 2 } 
	{ C_out_write sc_out sc_logic 1 signal 2 } 
	{ D_out_din sc_out sc_lv 64 signal 3 } 
	{ D_out_full_n sc_in sc_logic 1 signal 3 } 
	{ D_out_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "D_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "D_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	D_out { ap_fifo {  { D_out_din fifo_data 1 64 }  { D_out_full_n fifo_status 0 1 }  { D_out_write fifo_update 1 1 } } }
}
