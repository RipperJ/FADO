...
wire   [2:0] add_ln691_715_fu_153_p2;
reg   [2:0] add_ln691_715_reg_229;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln886_fu_179_p2;
reg   [0:0] icmp_ln886_reg_237;
wire   [0:0] icmp_ln890_569_fu_159_p2;
wire   [2:0] add_ln691_716_fu_185_p2;
reg   [2:0] add_ln691_716_reg_241;
wire    ap_CS_fsm_state4;
wire   [4:0] add_ln691_717_fu_197_p2;
reg   [4:0] add_ln691_717_reg_249;
wire    ap_CS_fsm_state5;
wire   [1:0] add_ln691_718_fu_209_p2;
reg   [1:0] add_ln691_718_reg_257;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_147_p2 == 1'd0))) begin
        ...
        c1_V_reg_97 <= add_ln691_715_reg_229;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_569_fu_159_p2 == 1'd0) & (icmp_ln886_fu_179_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        c4_V_reg_108 <= add_ln691_716_reg_241;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln886_reg_237 == 1'd0) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln890_570_fu_191_p2 == 1'd0))) begin
        ...
        c5_V_reg_119 <= add_ln691_717_reg_249;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_571_fu_203_p2 == 1'd0))) begin
        ...
        c6_V_reg_130 <= add_ln691_718_reg_257;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_715_reg_229 <= add_ln691_715_fu_153_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln886_reg_237 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        add_ln691_716_reg_241 <= add_ln691_716_fu_185_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        add_ln691_717_reg_249 <= add_ln691_717_fu_197_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_718_reg_257 <= add_ln691_718_fu_209_p2;
    end
end
...
assign add_ln691_715_fu_153_p2 = (c1_V_reg_97 + 3'd1);

assign add_ln691_716_fu_185_p2 = (c4_V_reg_108 + 3'd1);

assign add_ln691_717_fu_197_p2 = (c5_V_reg_119 + 5'd1);

assign add_ln691_718_fu_209_p2 = (c6_V_reg_130 + 2'd1);
