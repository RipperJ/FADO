...
wire   [0:0] icmp_ln878_1_fu_138_p2;
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln878_1_fu_138_p2 == 1'd0) & (fifo_B_B_IO_L2_in_0_x114_full_n == 1'b0)) & (icmp_ln878_1_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        p_V_reg_91 <= 2'd0;
    end else if ((~((icmp_ln878_1_fu_138_p2 == 1'd0) & (fifo_B_B_IO_L2_in_0_x114_full_n == 1'b0)) & (icmp_ln878_1_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((icmp_ln878_1_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if ((~((icmp_ln878_1_fu_138_p2 == 1'd0) & (fifo_B_B_IO_L2_in_0_x114_full_n == 1'b0)) & (icmp_ln878_1_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    ap_block_state4 = ((icmp_ln878_1_fu_138_p2 == 1'd0) & (fifo_B_B_IO_L2_in_0_x114_full_n == 1'b0));
end
...
assign icmp_ln878_1_fu_138_p2 = ((p_V_reg_91 == 2'd2) ? 1'b1 : 1'b0);
