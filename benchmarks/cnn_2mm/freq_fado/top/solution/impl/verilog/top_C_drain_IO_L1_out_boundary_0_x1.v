...
wire   [4:0] add_ln691_219_fu_271_p2;
reg   [4:0] add_ln691_219_reg_418;
wire    ap_CS_fsm_state3;
reg   [8:0] local_C_V_addr_reg_423;
wire   [63:0] local_C_V_q0;
wire    ap_CS_fsm_state4;
wire   [1:0] add_ln691_220_fu_295_p2;
reg    ap_block_state5;
wire   [63:0] zext_ln1497_fu_327_p1;
wire   [4:0] add_ln691_217_fu_340_p2;
reg   [4:0] add_ln691_217_reg_450;
wire    ap_CS_fsm_state8;
wire   [8:0] tmp_120_cast_fu_350_p3;
reg   [8:0] tmp_120_cast_reg_455;
wire   [5:0] add_ln691_218_fu_364_p2;
reg   [5:0] add_ln691_218_reg_463;
...
wire   [0:0] icmp_ln890_165_fu_289_p2;
reg    ap_block_state1;
...
wire   [0:0] icmp_ln890_166_fu_384_p2;
reg   [5:0] c6_V_55_reg_229;
wire   [0:0] icmp_ln890_164_fu_358_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_164_fu_358_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_246_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c5_V_reg_218 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_166_fu_384_p2 == 1'd1))) begin
        c5_V_reg_218 <= add_ln691_217_reg_450;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_164_fu_358_p2 == 1'd0))) begin
        c6_V_55_reg_229 <= 6'd0;
    end else if (((fifo_C_drain_C_drain_IO_L1_out_0_12_x1121_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state10))) begin
        c6_V_55_reg_229 <= add_ln691_218_reg_463;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c6_V_reg_176 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_165_fu_289_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_246_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        c7_V_reg_187 <= add_ln691_219_reg_418;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        n_V_reg_198 <= add_ln691_220_fu_295_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        add_ln691_217_reg_450 <= add_ln691_217_fu_340_p2;
        tmp_120_cast_reg_455[8 : 5] <= tmp_120_cast_fu_350_p3[8 : 5];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        add_ln691_218_reg_463 <= add_ln691_218_fu_364_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_219_reg_418 <= add_ln691_219_fu_271_p2;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_164_fu_358_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_165_fu_289_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_166_fu_384_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
...
assign add_ln11602_fu_374_p2 = (tmp_120_cast_reg_455 + zext_ln11602_fu_370_p1);

assign add_ln691_217_fu_340_p2 = (c5_V_reg_218 + 5'd1);

assign add_ln691_218_fu_364_p2 = (c6_V_55_reg_229 + 6'd1);

assign add_ln691_219_fu_271_p2 = (c7_V_reg_187 + 5'd1);

assign add_ln691_220_fu_295_p2 = (n_V_reg_198 + 2'd1);
...
assign icmp_ln890_164_fu_358_p2 = ((c5_V_reg_218 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_165_fu_289_p2 = ((c7_V_reg_187 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_166_fu_384_p2 = ((c6_V_55_reg_229 == 6'd32) ? 1'b1 : 1'b0);
...
assign tmp_120_cast_fu_350_p3 = {{trunc_ln11602_fu_346_p1}, {5'd0}};
...
always @ (posedge ap_clk) begin
    tmp_120_cast_reg_455[4:0] <= 5'b00000;
end
