set moduleName kernel3_x1_entry42
set isTopModule 0
...
set C_modelName {kernel3_x1.entry42}
...
set portList { 
	...
	{ C_out_din sc_out sc_lv 64 signal 1 } 
	{ C_out_full_n sc_in sc_logic 1 signal 1 } 
	{ C_out_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "C_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "33", "DependentChanType" : "2",
				"BlockSignal" : [
