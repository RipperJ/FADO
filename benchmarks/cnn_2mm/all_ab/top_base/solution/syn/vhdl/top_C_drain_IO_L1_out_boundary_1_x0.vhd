...
attribute shreg_extract : string;
    ...
    signal add_ln691_381_fu_271_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_381_reg_418 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal add_ln691_382_fu_295_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_state5 : BOOLEAN;
    signal zext_ln1497_fu_327_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln691_379_fu_340_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_379_reg_450 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal tmp_172_cast_fu_350_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_172_cast_reg_455 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln691_380_fu_364_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln691_380_reg_463 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal icmp_ln890_275_fu_289_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln890_276_fu_384_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c6_V_54_reg_229 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln890_274_fu_358_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_274_fu_358_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln890_276_fu_384_p2 = ap_const_lv1_1))) then 
                c5_V_reg_218 <= add_ln691_379_reg_450;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_274_fu_358_p2 = ap_const_lv1_0))) then 
                ...
                c6_V_54_reg_229 <= add_ln691_380_reg_463;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_275_fu_289_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_fu_246_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                ...
                c7_V_reg_187 <= add_ln691_381_reg_418;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                ...
                n_V_reg_198 <= add_ln691_382_fu_295_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                add_ln691_379_reg_450 <= add_ln691_379_fu_340_p2;
                    tmp_172_cast_reg_455(8 downto 5) <= tmp_172_cast_fu_350_p3(8 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then
                add_ln691_380_reg_463 <= add_ln691_380_fu_364_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                add_ln691_381_reg_418 <= add_ln691_381_fu_271_p2;
    ...
    tmp_172_cast_reg_455(4 downto 0) <= "00000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_C_drain_C_drain_IO_L1_out_1_12_x0134_full_n, fifo_C_drain_PE_12_1_x0108_empty_n, ap_CS_fsm_state10, ap_CS_fsm_state5, icmp_ln878_fu_306_p2, ap_CS_fsm_state2, icmp_ln890_fu_246_p2, ap_CS_fsm_state3, ap_CS_fsm_state8, ap_CS_fsm_state9, icmp_ln890_275_fu_289_p2, icmp_ln890_276_fu_384_p2, icmp_ln890_274_fu_358_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_275_fu_289_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
            ...
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_274_fu_358_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state9;
                end if;
            when ap_ST_fsm_state9 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln890_276_fu_384_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                else
    ...
    add_ln5243_fu_374_p2 <= std_logic_vector(unsigned(tmp_172_cast_reg_455) + unsigned(zext_ln5243_fu_370_p1));
    add_ln691_379_fu_340_p2 <= std_logic_vector(unsigned(c5_V_reg_218) + unsigned(ap_const_lv5_1));
    add_ln691_380_fu_364_p2 <= std_logic_vector(unsigned(c6_V_54_reg_229) + unsigned(ap_const_lv6_1));
    add_ln691_381_fu_271_p2 <= std_logic_vector(unsigned(c7_V_reg_187) + unsigned(ap_const_lv5_1));
    add_ln691_382_fu_295_p2 <= std_logic_vector(unsigned(n_V_reg_198) + unsigned(ap_const_lv2_1));
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state8, icmp_ln890_274_fu_358_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_274_fu_358_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state8, icmp_ln890_274_fu_358_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_274_fu_358_p2 = ap_const_lv1_1))) then 
    ...
    icmp_ln890_274_fu_358_p2 <= "1" when (c5_V_reg_218 = ap_const_lv5_10) else "0";
    icmp_ln890_275_fu_289_p2 <= "1" when (c7_V_reg_187 = ap_const_lv5_10) else "0";
    icmp_ln890_276_fu_384_p2 <= "1" when (c6_V_54_reg_229 = ap_const_lv6_20) else "0";
    ...
    tmp_172_cast_fu_350_p3 <= (trunc_ln5243_fu_346_p1 & ap_const_lv5_0);
