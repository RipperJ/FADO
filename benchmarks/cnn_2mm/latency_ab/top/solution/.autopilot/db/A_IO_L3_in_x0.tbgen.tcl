...
set C_modelName {A_IO_L3_in_x0}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_A int 512 regular {axi_master 0}  }
	{ fifo_A_local_out int 256 regular {fifo 1 volatile }  }
	{ A int 64 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_A", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "fifo_A_local_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ fifo_A_local_out_din sc_out sc_lv 256 signal 1 } 
	{ fifo_A_local_out_full_n sc_in sc_logic 1 signal 1 } 
	{ fifo_A_local_out_write sc_out sc_logic 1 signal 1 } 
	{ A_dout sc_in sc_lv 64 signal 2 } 
	{ A_empty_n sc_in sc_logic 1 signal 2 } 
	{ A_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_A_local_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "fifo_A_local_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	fifo_A_local_out { ap_fifo {  { fifo_A_local_out_din fifo_data 1 256 }  { fifo_A_local_out_full_n fifo_status 0 1 }  { fifo_A_local_out_write fifo_update 1 1 } } }
