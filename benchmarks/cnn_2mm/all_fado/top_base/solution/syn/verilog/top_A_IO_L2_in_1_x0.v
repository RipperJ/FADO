...
wire   [4:0] add_ln691_803_fu_206_p2;
reg   [4:0] add_ln691_803_reg_331;
wire    ap_CS_fsm_state3;
wire   [8:0] tmp_368_cast_fu_216_p3;
reg   [8:0] tmp_368_cast_reg_336;
wire   [3:0] add_ln691_fu_230_p2;
wire   [0:0] icmp_ln890_647_fu_224_p2;
wire   [5:0] add_ln691_806_fu_236_p2;
reg   [5:0] add_ln691_806_reg_349;
wire    ap_CS_fsm_state4;
reg   [8:0] local_A_pong_V_addr_reg_354;
wire   [5:0] add_ln691_802_fu_262_p2;
reg   [5:0] add_ln691_802_reg_362;
wire    ap_CS_fsm_state6;
wire   [8:0] zext_ln890_fu_268_p1;
reg   [8:0] zext_ln890_reg_367;
wire   [6:0] add_ln691_804_fu_278_p2;
reg   [6:0] add_ln691_804_reg_375;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_805_fu_290_p2;
reg   [4:0] add_ln691_805_reg_383;
...
wire   [0:0] icmp_ln890_649_fu_256_p2;
reg   [5:0] c5_V_24_reg_150;
reg    ap_block_state5;
reg   [5:0] c5_V_reg_161;
wire   [0:0] icmp_ln890_648_fu_284_p2;
reg   [6:0] c6_V_reg_172;
wire   [0:0] icmp_ln890_650_fu_318_p2;
wire   [0:0] icmp_ln890_646_fu_272_p2;
reg   [4:0] c7_V_reg_183;
wire   [63:0] zext_ln152_1_fu_251_p1;
wire   [63:0] zext_ln169_fu_313_p1;
wire   [3:0] trunc_ln152_fu_212_p1;
wire   [8:0] zext_ln152_fu_242_p1;
wire   [8:0] add_ln152_fu_246_p2;
wire   [3:0] trunc_ln169_fu_296_p1;
wire   [8:0] tmp_cast_fu_300_p3;
wire   [8:0] add_ln169_fu_308_p2;
reg   [8:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_646_fu_272_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c3_V_reg_127 <= 4'd1;
    end else if (((icmp_ln890_647_fu_224_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_194_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_139 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_649_fu_256_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln890_647_fu_224_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c5_V_24_reg_150 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_194_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c5_V_reg_161 <= 6'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_648_fu_284_p2 == 1'd1))) begin
        c5_V_reg_161 <= add_ln691_802_reg_362;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_646_fu_272_p2 == 1'd0))) begin
        c6_V_reg_172 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_650_fu_318_p2 == 1'd1))) begin
        c6_V_reg_172 <= add_ln691_804_reg_375;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_648_fu_284_p2 == 1'd0))) begin
        c7_V_reg_183 <= 5'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        ...
        tmp_368_cast_reg_336[8 : 5] <= tmp_368_cast_fu_216_p3[8 : 5];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        local_A_pong_V_addr_reg_354 <= zext_ln152_1_fu_251_p1;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_646_fu_272_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_647_fu_224_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_649_fu_256_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_648_fu_284_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_650_fu_318_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
...
assign add_ln152_fu_246_p2 = (tmp_368_cast_reg_336 + zext_ln152_fu_242_p1);

assign add_ln169_fu_308_p2 = (tmp_cast_fu_300_p3 + zext_ln890_reg_367);

assign add_ln691_802_fu_262_p2 = (c5_V_reg_161 + 6'd1);

assign add_ln691_803_fu_206_p2 = (c4_V_reg_139 + 5'd1);

assign add_ln691_804_fu_278_p2 = (c6_V_reg_172 + 7'd1);

assign add_ln691_805_fu_290_p2 = (c7_V_reg_183 + 5'd1);

assign add_ln691_806_fu_236_p2 = (c5_V_24_reg_150 + 6'd1);
...
assign icmp_ln890_646_fu_272_p2 = ((c5_V_reg_161 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_647_fu_224_p2 = ((c4_V_reg_139 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_648_fu_284_p2 = ((c6_V_reg_172 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln890_649_fu_256_p2 = ((c5_V_24_reg_150 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_650_fu_318_p2 = ((c7_V_reg_183 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_fu_194_p2 = ((c3_V_reg_127 == 4'd13) ? 1'b1 : 1'b0);

assign local_A_pong_V_address0 = zext_ln169_fu_313_p1;

assign tmp_368_cast_fu_216_p3 = {{trunc_ln152_fu_212_p1}, {5'd0}};

assign tmp_cast_fu_300_p3 = {{trunc_ln169_fu_296_p1}, {5'd0}};

assign trunc_ln152_fu_212_p1 = c4_V_reg_139[3:0];

assign trunc_ln169_fu_296_p1 = c7_V_reg_183[3:0];

assign zext_ln152_1_fu_251_p1 = add_ln152_fu_246_p2;

assign zext_ln152_fu_242_p1 = c5_V_24_reg_150;

assign zext_ln169_fu_313_p1 = add_ln169_fu_308_p2;

assign zext_ln890_fu_268_p1 = c5_V_reg_161;

always @ (posedge ap_clk) begin
    tmp_368_cast_reg_336[4:0] <= 5'b00000;
