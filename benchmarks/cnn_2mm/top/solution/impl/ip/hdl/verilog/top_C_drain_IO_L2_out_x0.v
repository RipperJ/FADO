...
wire   [13:0] add_ln890_106_fu_110_p2;
...
wire   [0:0] select_ln5260_fu_146_p3;
wire   [1:0] select_ln890_fu_154_p3;
wire   [13:0] select_ln890_262_fu_168_p3;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_151)) begin
        if (((select_ln5260_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0))) begin
            ap_phi_reg_pp0_iter2_fifo_data_4_reg_100 <= fifo_C_drain_C_drain_IO_L2_out_1_x0136_dout;
        end else if (((select_ln5260_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0))) begin
...
always @ (*) begin
    if (((select_ln5260_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((select_ln5260_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln890_106_fu_110_p2 = (indvar_flatten31_reg_67 + 14'd1);
...
always @ (*) begin
    ap_predicate_op31_read_state3 = ((select_ln5260_reg_185 == 1'd0) & (icmp_ln890_reg_181 == 1'd0));
end

always @ (*) begin
    ap_predicate_op33_read_state3 = ((select_ln5260_reg_185 == 1'd1) & (icmp_ln890_reg_181 == 1'd0));
end
...
assign fifo_C_drain_C_drain_IO_L2_out_0_x0135_din = ap_phi_reg_pp0_iter2_fifo_data_4_reg_100;
...
assign select_ln5260_fu_146_p3 = ((icmp_ln89038_fu_140_p2[0:0] == 1'b1) ? cmp_i_i_mid1_fu_128_p2 : cmp_i_i35_fu_134_p2);

assign select_ln890_262_fu_168_p3 = ((icmp_ln89038_fu_140_p2[0:0] == 1'b1) ? 14'd1 : add_ln890_fu_162_p2);
