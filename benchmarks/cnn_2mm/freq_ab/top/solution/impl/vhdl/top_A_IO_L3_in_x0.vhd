...
attribute shreg_extract : string;
    ...
    signal icmp_ln878_6_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal A_blk_n : STD_LOGIC;
    signal trunc_ln_reg_197 : STD_LOGIC_VECTOR (57 downto 0);
    signal i_V_6_fu_154_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_V_6_reg_208 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sext_ln68_fu_144_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((icmp_ln878_6_fu_172_p2 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_6_fu_172_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((icmp_ln878_6_fu_172_p2 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_6_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state73)) then
                mem_data_V_reg_216 <= m_axi_gmem_A_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_197 <= A_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_A_ARREADY, m_axi_gmem_A_RVALID, fifo_A_local_out_full_n, A_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state73, ap_CS_fsm_state75, icmp_ln878_6_fu_172_p2, ap_CS_fsm_state72, icmp_ln878_fu_160_p2)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state75_assign_proc : process(fifo_A_local_out_full_n, icmp_ln878_6_fu_172_p2)
    begin
                ap_block_state75 <= ((icmp_ln878_6_fu_172_p2 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0));
    end process;
    ...
    fifo_A_local_out_blk_n_assign_proc : process(fifo_A_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_6_fu_172_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_6_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    fifo_A_local_out_din <= p_Val2_s_reg_125(256 - 1 downto 0);

    fifo_A_local_out_write_assign_proc : process(fifo_A_local_out_full_n, ap_CS_fsm_state75, icmp_ln878_6_fu_172_p2)
    begin
        if ((not(((icmp_ln878_6_fu_172_p2 = ap_const_lv1_0) and (fifo_A_local_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state75) and (icmp_ln878_6_fu_172_p2 = ap_const_lv1_0))) then 
    ...
    i_V_6_fu_154_p2 <= std_logic_vector(unsigned(i_V_reg_103) + unsigned(ap_const_lv11_1));
    icmp_ln878_6_fu_172_p2 <= "1" when (p_V_reg_114 = ap_const_lv2_2) else "0";
    icmp_ln878_fu_160_p2 <= "1" when (i_V_reg_103 = ap_const_lv11_400) else "0";
    m_axi_gmem_A_ARADDR <= sext_ln68_fu_144_p1;
    ...
    r_fu_183_p4 <= p_Val2_s_reg_125(511 downto 256);
        sext_ln68_fu_144_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_197),64));
