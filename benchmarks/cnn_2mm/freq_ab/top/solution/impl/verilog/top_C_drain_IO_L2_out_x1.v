...
wire   [0:0] icmp_ln890_160_fu_183_p2;
...
wire   [3:0] add_ln691_210_fu_153_p2;
reg   [3:0] add_ln691_210_reg_201;
wire    ap_CS_fsm_state3;
wire   [4:0] add_ln691_211_fu_165_p2;
reg   [4:0] add_ln691_211_reg_209;
wire    ap_CS_fsm_state4;
wire   [5:0] add_ln691_212_fu_177_p2;
reg   [5:0] add_ln691_212_reg_217;
reg    ap_predicate_op43_read_state5;
reg    ap_predicate_op45_read_state5;
reg    ap_block_state5;
reg   [1:0] c3_V_reg_81;
wire   [0:0] icmp_ln890_158_fu_159_p2;
reg    ap_block_state1;
reg   [3:0] c4_V_reg_92;
wire   [0:0] icmp_ln890_159_fu_171_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c3_V_reg_81 <= 2'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_158_fu_159_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_141_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_92 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_159_fu_171_p2 == 1'd1))) begin
        c4_V_reg_92 <= add_ln691_210_reg_201;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_158_fu_159_p2 == 1'd0))) begin
        c5_V_reg_103 <= 5'd0;
    end else if ((~(((ap_predicate_op45_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_empty_n == 1'b0)) | ((ap_predicate_op43_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L2_out_1_x1136_empty_n == 1'b0))) & (icmp_ln890_160_fu_183_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        c5_V_reg_103 <= add_ln691_211_reg_209;
    end
end

always @ (posedge ap_clk) begin
    if (((fifo_C_drain_C_drain_IO_L2_out_0_x1135_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state6))) begin
        c6_V_reg_114 <= add_ln691_212_reg_217;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_159_fu_171_p2 == 1'd0))) begin
        c6_V_reg_114 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_210_reg_201 <= add_ln691_210_fu_153_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        add_ln691_211_reg_209 <= add_ln691_211_fu_165_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~(((ap_predicate_op45_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_empty_n == 1'b0)) | ((ap_predicate_op43_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L2_out_1_x1136_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state5))) begin
        add_ln691_212_reg_217 <= add_ln691_212_fu_177_p2;
    end
end
...
always @ (*) begin
    if (((cmp_i_i_reg_197 == 1'd1) & (icmp_ln890_160_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((cmp_i_i_reg_197 == 1'd0) & (icmp_ln890_160_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_158_fu_159_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_159_fu_171_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if ((~(((ap_predicate_op45_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_empty_n == 1'b0)) | ((ap_predicate_op43_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L2_out_1_x1136_empty_n == 1'b0))) & (icmp_ln890_160_fu_183_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if ((~(((ap_predicate_op45_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_empty_n == 1'b0)) | ((ap_predicate_op43_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L2_out_1_x1136_empty_n == 1'b0))) & (icmp_ln890_160_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign add_ln691_210_fu_153_p2 = (c4_V_reg_92 + 4'd1);

assign add_ln691_211_fu_165_p2 = (c5_V_reg_103 + 5'd1);

assign add_ln691_212_fu_177_p2 = (c6_V_reg_114 + 6'd1);
...
always @ (*) begin
    ap_condition_193 = (~(((ap_predicate_op45_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L1_out_0_0_x1109_empty_n == 1'b0)) | ((ap_predicate_op43_read_state5 == 1'b1) & (fifo_C_drain_C_drain_IO_L2_out_1_x1136_empty_n == 1'b0))) & (icmp_ln890_160_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5));
end

always @ (*) begin
    ap_predicate_op43_read_state5 = ((cmp_i_i_reg_197 == 1'd0) & (icmp_ln890_160_fu_183_p2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op45_read_state5 = ((cmp_i_i_reg_197 == 1'd1) & (icmp_ln890_160_fu_183_p2 == 1'd0));
end
...
assign icmp_ln890_158_fu_159_p2 = ((c4_V_reg_92 == 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln890_159_fu_171_p2 = ((c5_V_reg_103 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_160_fu_183_p2 = ((c6_V_reg_114 == 6'd32) ? 1'b1 : 1'b0);
