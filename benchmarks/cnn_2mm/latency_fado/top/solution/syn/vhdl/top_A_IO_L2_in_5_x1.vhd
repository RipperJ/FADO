...
attribute shreg_extract : string;
    ...
    signal add_ln691_758_fu_208_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_758_reg_333 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_350_cast_fu_218_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_350_cast_reg_338 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln691_fu_232_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln890_602_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_761_fu_238_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln691_761_reg_351 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal local_A_pong_V_addr_reg_356 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln691_757_fu_264_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln691_757_reg_364 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal add_ln691_759_fu_280_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln691_759_reg_377 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal add_ln691_760_fu_292_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_760_reg_385 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal icmp_ln890_604_fu_258_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c5_V_15_reg_152 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_state5 : BOOLEAN;
    signal c5_V_reg_163 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln890_603_fu_286_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c6_V_reg_174 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln890_605_fu_320_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln890_601_fu_274_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c7_V_reg_185 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln6759_1_fu_253_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln6776_fu_315_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal trunc_ln6759_fu_214_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln6759_fu_244_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln6759_fu_248_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal trunc_ln6776_fu_298_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_cast_fu_302_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln6776_fu_310_p2 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_601_fu_274_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_602_fu_226_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln890_604_fu_258_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_602_fu_226_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state7) and (icmp_ln890_603_fu_286_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_601_fu_274_p2 = ap_const_lv1_0))) then 
                c6_V_reg_174 <= ap_const_lv7_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_605_fu_320_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state7) and (icmp_ln890_603_fu_286_p2 = ap_const_lv1_0))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                add_ln691_758_reg_333 <= add_ln691_758_fu_208_p2;
                    tmp_350_cast_reg_338(8 downto 5) <= tmp_350_cast_fu_218_p3(8 downto 5);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                local_A_pong_V_addr_reg_356 <= zext_ln6759_1_fu_253_p1(9 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tmp_350_cast_reg_338(4 downto 0) <= "00000";
    zext_ln890_reg_369(8 downto 6) <= "000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_A_A_IO_L2_in_5_x16_empty_n, fifo_A_A_IO_L2_in_6_x17_full_n, fifo_A_PE_5_0_x131_full_n, ap_CS_fsm_state5, cmp_i_i72_reg_329, ap_CS_fsm_state9, ap_CS_fsm_state2, icmp_ln890_fu_196_p2, ap_CS_fsm_state3, icmp_ln890_602_fu_226_p2, ap_CS_fsm_state4, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_CS_fsm_state8, icmp_ln890_604_fu_258_p2, icmp_ln890_603_fu_286_p2, icmp_ln890_605_fu_320_p2, icmp_ln890_601_fu_274_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((icmp_ln890_602_fu_226_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln890_604_fu_258_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
            ...
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_601_fu_274_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
            when ap_ST_fsm_state7 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state7) and (icmp_ln890_603_fu_286_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                else
                    ap_NS_fsm <= ap_ST_fsm_state8;
                end if;
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_605_fu_320_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state7;
                else
    ...
    add_ln6759_fu_248_p2 <= std_logic_vector(unsigned(tmp_350_cast_reg_338) + unsigned(zext_ln6759_fu_244_p1));
    add_ln6776_fu_310_p2 <= std_logic_vector(unsigned(tmp_cast_fu_302_p3) + unsigned(zext_ln890_reg_369));
    add_ln691_757_fu_264_p2 <= std_logic_vector(unsigned(c5_V_reg_163) + unsigned(ap_const_lv6_1));
    add_ln691_758_fu_208_p2 <= std_logic_vector(unsigned(c4_V_reg_141) + unsigned(ap_const_lv5_1));
    add_ln691_759_fu_280_p2 <= std_logic_vector(unsigned(c6_V_reg_174) + unsigned(ap_const_lv7_1));
    add_ln691_760_fu_292_p2 <= std_logic_vector(unsigned(c7_V_reg_185) + unsigned(ap_const_lv5_1));
    add_ln691_761_fu_238_p2 <= std_logic_vector(unsigned(c5_V_15_reg_152) + unsigned(ap_const_lv6_1));
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state6, icmp_ln890_601_fu_274_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_601_fu_274_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state6, icmp_ln890_601_fu_274_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_601_fu_274_p2 = ap_const_lv1_1))) then 
    ...
    icmp_ln890_601_fu_274_p2 <= "1" when (c5_V_reg_163 = ap_const_lv6_20) else "0";
    icmp_ln890_602_fu_226_p2 <= "1" when (c4_V_reg_141 = ap_const_lv5_10) else "0";
    icmp_ln890_603_fu_286_p2 <= "1" when (c6_V_reg_174 = ap_const_lv7_40) else "0";
    icmp_ln890_604_fu_258_p2 <= "1" when (c5_V_15_reg_152 = ap_const_lv6_20) else "0";
    icmp_ln890_605_fu_320_p2 <= "1" when (c7_V_reg_185 = ap_const_lv5_10) else "0";
    icmp_ln890_fu_196_p2 <= "1" when (c3_V_reg_129 = ap_const_lv4_D) else "0";
    local_A_pong_V_address0 <= zext_ln6776_fu_315_p1(9 - 1 downto 0);
    ...
    tmp_350_cast_fu_218_p3 <= (trunc_ln6759_fu_214_p1 & ap_const_lv5_0);
    tmp_cast_fu_302_p3 <= (trunc_ln6776_fu_298_p1 & ap_const_lv5_0);
    trunc_ln6759_fu_214_p1 <= c4_V_reg_141(4 - 1 downto 0);
    trunc_ln6776_fu_298_p1 <= c7_V_reg_185(4 - 1 downto 0);
    zext_ln6759_1_fu_253_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln6759_fu_248_p2),64));
    zext_ln6759_fu_244_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(c5_V_15_reg_152),9));
    zext_ln6776_fu_315_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln6776_fu_310_p2),64));
