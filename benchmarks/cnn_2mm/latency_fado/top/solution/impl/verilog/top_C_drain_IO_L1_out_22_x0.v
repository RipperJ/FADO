...
wire   [4:0] add_ln691_487_fu_316_p2;
reg   [4:0] add_ln691_487_reg_481;
wire    ap_CS_fsm_state3;
reg   [8:0] local_C_V_addr_reg_486;
wire   [1:0] add_ln691_488_fu_340_p2;
reg    ap_block_state5;
wire   [63:0] zext_ln1497_fu_372_p1;
wire   [0:0] cmp_i_i_fu_391_p2;
reg   [0:0] cmp_i_i_reg_511;
wire    ap_CS_fsm_state8;
wire   [0:0] icmp_ln890_359_fu_385_p2;
wire   [4:0] add_ln691_489_fu_397_p2;
reg   [4:0] add_ln691_489_reg_515;
wire    ap_CS_fsm_state9;
wire   [8:0] tmp_236_cast_fu_407_p3;
reg   [8:0] tmp_236_cast_reg_520;
wire   [3:0] add_ln691_486_fu_421_p2;
wire   [0:0] icmp_ln890_361_fu_415_p2;
wire   [5:0] add_ln691_490_fu_427_p2;
reg   [5:0] add_ln691_490_reg_533;
...
wire   [0:0] icmp_ln890_360_fu_334_p2;
reg    ap_block_state1;
...
wire   [0:0] icmp_ln890_362_fu_447_p2;
reg   [5:0] c6_V_76_reg_258;
reg   [63:0] fifo_data_24_reg_269;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_359_fu_385_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_291_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_235 <= 4'd1;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_361_fu_415_p2 == 1'd1))) begin
        c4_V_reg_235 <= add_ln691_486_fu_421_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_359_fu_385_p2 == 1'd0))) begin
        c5_V_reg_247 <= 5'd0;
    end else if (((icmp_ln890_362_fu_447_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_361_fu_415_p2 == 1'd0))) begin
        c6_V_76_reg_258 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c6_V_reg_193 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_360_fu_334_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_236_cast_reg_520[8 : 5] <= tmp_236_cast_fu_407_p3[8 : 5];
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_359_fu_385_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_360_fu_334_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_361_fu_415_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else begin
        ...
        ap_ST_fsm_state10 : begin
            if (((icmp_ln890_362_fu_447_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if (((icmp_ln890_362_fu_447_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10) & (cmp_i_i_reg_511 == 1'd1))) begin
...
assign add_ln5073_fu_437_p2 = (tmp_236_cast_reg_520 + zext_ln5073_fu_433_p1);

assign add_ln691_486_fu_421_p2 = (c4_V_reg_235 + 4'd1);

assign add_ln691_487_fu_316_p2 = (c7_V_reg_204 + 5'd1);

assign add_ln691_488_fu_340_p2 = (n_V_reg_215 + 2'd1);

assign add_ln691_489_fu_397_p2 = (c5_V_reg_247 + 5'd1);

assign add_ln691_490_fu_427_p2 = (c6_V_76_reg_258 + 6'd1);
...
assign fifo_C_drain_C_drain_IO_L1_out_1_1_x0123_din = fifo_data_24_reg_269;

assign icmp_ln878_fu_351_p2 = ((n_V_reg_215 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln890_359_fu_385_p2 = ((c4_V_reg_235 == 4'd13) ? 1'b1 : 1'b0);

assign icmp_ln890_360_fu_334_p2 = ((c7_V_reg_204 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_361_fu_415_p2 = ((c5_V_reg_247 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_362_fu_447_p2 = ((c6_V_76_reg_258 == 6'd32) ? 1'b1 : 1'b0);
...
assign tmp_236_cast_fu_407_p3 = {{trunc_ln5073_fu_403_p1}, {5'd0}};
...
assign zext_ln5073_fu_433_p1 = c6_V_76_reg_258;

assign zext_ln878_fu_346_p1 = n_V_reg_215;

always @ (posedge ap_clk) begin
    tmp_236_cast_reg_520[4:0] <= 5'b00000;
end
