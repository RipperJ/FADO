...
attribute shreg_extract : string;
    ...
    signal i_V_2_fu_183_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal i_V_2_reg_271 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal v2_V_1319_reg_297 : STD_LOGIC_VECTOR (63 downto 0);
    signal v2_V_1320_reg_302 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal v2_V_1321_reg_307 : STD_LOGIC_VECTOR (63 downto 0);
    signal v2_V_1322_reg_312 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal v2_V_1323_reg_317 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal i_V_reg_160 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal p_V_reg_172 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln878_fu_189_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln534_fu_226_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln878_54_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln878_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln878_fu_189_p2 = ap_const_lv1_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_C_drain_C_drain_IO_L2_out_0_x0135_empty_n, ap_CS_fsm_state4, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln878_fu_189_p2, icmp_ln878_54_fu_205_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln878_fu_189_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln878_54_fu_205_p2 = ap_const_lv1_1))) then
    ...
    C_address0 <= zext_ln534_fu_226_p1(10 - 1 downto 0);
    ...
    C_d0 <= (((((((mem_data_split_V_q1 & mem_data_split_V_q0) & v2_V_1323_reg_317) & v2_V_1322_reg_312) & v2_V_1321_reg_307) & v2_V_1320_reg_302) & v2_V_1319_reg_297) & v2_V_reg_292);
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln878_fu_189_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln878_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln878_fu_189_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln878_fu_189_p2 = ap_const_lv1_1))) then 
    ...
    i_V_2_fu_183_p2 <= std_logic_vector(unsigned(i_V_reg_160) + unsigned(ap_const_lv11_1));
    icmp_ln878_54_fu_205_p2 <= "1" when (p_V_reg_172 = ap_const_lv4_8) else "0";
    icmp_ln878_fu_189_p2 <= "1" when (i_V_reg_160 = ap_const_lv11_400) else "0";
