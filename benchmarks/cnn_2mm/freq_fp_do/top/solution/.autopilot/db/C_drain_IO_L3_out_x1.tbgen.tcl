...
set C_modelArgList {
	...
	{ fifo_C_drain_local_in int 64 regular {fifo 0 volatile }  }
	{ C int 64 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_C", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "fifo_C_drain_local_in", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_C_drain_local_in_dout sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_C_drain_local_in_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fifo_C_drain_local_in", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "C", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "33", "DependentChanType" : "2",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "23622", "Max" : "23622"}
	, {"Name" : "Interval", "Min" : "23622", "Max" : "23622"}
]}
...
set Spec2ImplPortList { 
	...
	fifo_C_drain_local_in { ap_fifo {  { fifo_C_drain_local_in_dout fifo_data 0 64 }  { fifo_C_drain_local_in_empty_n fifo_status 0 1 }  { fifo_C_drain_local_in_read fifo_update 1 1 } } }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8263", "Max" : "8263"}
	, {"Name" : "Interval", "Min" : "8263", "Max" : "8263"}
]}
