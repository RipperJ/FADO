...
wire   [4:0] add_ln691_833_fu_213_p2;
reg   [4:0] add_ln691_833_reg_337;
wire    ap_CS_fsm_state3;
wire   [8:0] tmp_380_cast_fu_223_p3;
reg   [8:0] tmp_380_cast_reg_342;
wire   [5:0] add_ln691_836_fu_237_p2;
reg   [5:0] add_ln691_836_reg_350;
wire    ap_CS_fsm_state4;
reg   [8:0] local_A_pong_V_addr_reg_355;
wire   [5:0] add_ln691_832_fu_263_p2;
reg   [5:0] add_ln691_832_reg_363;
wire    ap_CS_fsm_state6;
wire   [8:0] zext_ln890_fu_269_p1;
reg   [8:0] zext_ln890_reg_368;
wire   [6:0] add_ln691_834_fu_279_p2;
reg   [6:0] add_ln691_834_reg_376;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_835_fu_291_p2;
reg   [4:0] add_ln691_835_reg_384;
...
wire   [0:0] icmp_ln890_677_fu_231_p2;
reg    ap_block_state1;
reg   [4:0] c4_V_reg_140;
wire   [0:0] icmp_ln890_679_fu_257_p2;
reg   [5:0] c5_V_30_reg_151;
reg    ap_block_state5;
reg   [5:0] c5_V_reg_162;
wire   [0:0] icmp_ln890_678_fu_285_p2;
reg   [6:0] c6_V_reg_173;
wire   [0:0] icmp_ln890_680_fu_319_p2;
wire   [0:0] icmp_ln890_676_fu_273_p2;
reg   [4:0] c7_V_reg_184;
wire   [63:0] zext_ln104_1_fu_252_p1;
wire   [63:0] zext_ln121_fu_314_p1;
wire   [3:0] trunc_ln104_fu_219_p1;
wire   [8:0] zext_ln104_fu_243_p1;
wire   [8:0] add_ln104_fu_247_p2;
wire   [3:0] trunc_ln121_fu_297_p1;
wire   [8:0] tmp_cast_fu_301_p3;
wire   [8:0] add_ln121_fu_309_p2;
reg   [8:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_676_fu_273_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c3_V_reg_129 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_677_fu_231_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_201_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c4_V_reg_140 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_679_fu_257_p2 == 1'd1))) begin
        c4_V_reg_140 <= add_ln691_833_reg_337;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((fifo_A_A_IO_L2_in_0_x01_empty_n == 1'b0) | ((cmp_i_i72_reg_333 == 1'd0) & (fifo_A_A_IO_L2_in_1_x02_full_n == 1'b0))) & (1'b1 == ap_CS_fsm_state5))) begin
        c5_V_30_reg_151 <= add_ln691_836_reg_350;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_677_fu_231_p2 == 1'd0))) begin
        c5_V_30_reg_151 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_201_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        c5_V_reg_162 <= 6'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_678_fu_285_p2 == 1'd1))) begin
        c5_V_reg_162 <= add_ln691_832_reg_363;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_676_fu_273_p2 == 1'd0))) begin
        c6_V_reg_173 <= 7'd0;
    end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_680_fu_319_p2 == 1'd1))) begin
        c6_V_reg_173 <= add_ln691_834_reg_376;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_678_fu_285_p2 == 1'd0))) begin
        c7_V_reg_184 <= 5'd0;
    end else if (((fifo_A_PE_0_0_x016_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        c7_V_reg_184 <= add_ln691_835_reg_384;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_832_reg_363 <= add_ln691_832_fu_263_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_833_reg_337 <= add_ln691_833_fu_213_p2;
        tmp_380_cast_reg_342[8 : 5] <= tmp_380_cast_fu_223_p3[8 : 5];
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        add_ln691_834_reg_376 <= add_ln691_834_fu_279_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        add_ln691_835_reg_384 <= add_ln691_835_fu_291_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        add_ln691_836_reg_350 <= add_ln691_836_fu_237_p2;
        local_A_pong_V_addr_reg_355 <= zext_ln104_1_fu_252_p1;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_676_fu_273_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_677_fu_231_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln890_679_fu_257_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_678_fu_285_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_680_fu_319_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state7;
            end else begin
...
assign add_ln104_fu_247_p2 = (tmp_380_cast_reg_342 + zext_ln104_fu_243_p1);

assign add_ln121_fu_309_p2 = (tmp_cast_fu_301_p3 + zext_ln890_reg_368);

assign add_ln691_832_fu_263_p2 = (c5_V_reg_162 + 6'd1);

assign add_ln691_833_fu_213_p2 = (c4_V_reg_140 + 5'd1);

assign add_ln691_834_fu_279_p2 = (c6_V_reg_173 + 7'd1);

assign add_ln691_835_fu_291_p2 = (c7_V_reg_184 + 5'd1);

assign add_ln691_836_fu_237_p2 = (c5_V_30_reg_151 + 6'd1);
...
assign icmp_ln890_676_fu_273_p2 = ((c5_V_reg_162 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_677_fu_231_p2 = ((c4_V_reg_140 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_678_fu_285_p2 = ((c6_V_reg_173 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln890_679_fu_257_p2 = ((c5_V_30_reg_151 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln890_680_fu_319_p2 = ((c7_V_reg_184 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_fu_201_p2 = ((c3_V_reg_129 == 4'd13) ? 1'b1 : 1'b0);

assign local_A_pong_V_address0 = zext_ln121_fu_314_p1;

assign tmp_380_cast_fu_223_p3 = {{trunc_ln104_fu_219_p1}, {5'd0}};

assign tmp_cast_fu_301_p3 = {{trunc_ln121_fu_297_p1}, {5'd0}};

assign trunc_ln104_fu_219_p1 = c4_V_reg_140[3:0];

assign trunc_ln121_fu_297_p1 = c7_V_reg_184[3:0];

assign zext_ln104_1_fu_252_p1 = add_ln104_fu_247_p2;

assign zext_ln104_fu_243_p1 = c5_V_30_reg_151;

assign zext_ln121_fu_314_p1 = add_ln121_fu_309_p2;

assign zext_ln890_fu_269_p1 = c5_V_reg_162;

always @ (posedge ap_clk) begin
    tmp_380_cast_reg_342[4:0] <= 5'b00000;
