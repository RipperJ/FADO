set moduleName B_IO_L3_in_serialize_x0
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_B", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "B", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ B_dout sc_in sc_lv 64 signal 2 } 
	{ B_empty_n sc_in sc_logic 1 signal 2 } 
	{ B_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1572935", "Max" : "1572935"}
	, {"Name" : "Interval", "Min" : "1572935", "Max" : "1572935"}
]}
...
set Spec2ImplPortList { 
	...
	B { ap_fifo {  { B_dout fifo_data 0 64 }  { B_empty_n fifo_status 0 1 }  { B_read fifo_update 1 1 } } }
}
set moduleName B_IO_L3_in_serialize_x0
set isTopModule 0
set isCombinational 0
