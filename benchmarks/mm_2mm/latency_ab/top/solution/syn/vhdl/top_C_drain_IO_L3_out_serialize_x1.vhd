...
attribute shreg_extract : string;
    ...
    signal trunc_ln37827_1_reg_242 : STD_LOGIC_VECTOR (57 downto 0);
    signal i_V_1_fu_205_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_V_1_reg_273 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal v2_V_15491_reg_299 : STD_LOGIC_VECTOR (127 downto 0);
    signal v2_V_15492_reg_304 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal i_V_reg_163 : STD_LOGIC_VECTOR (15 downto 0);
    signal p_V_reg_174 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln37818_fu_211_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln37827_fu_195_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln878_fu_227_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln37818_fu_211_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln37827_1_reg_242 <= C_dout(63 downto 6);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((icmp_ln878_fu_227_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    i_V_1_fu_205_p2 <= std_logic_vector(unsigned(i_V_reg_163) + unsigned(ap_const_lv16_1));
    icmp_ln37818_fu_211_p2 <= "1" when (i_V_reg_163 = ap_const_lv16_8000) else "0";
    icmp_ln878_fu_227_p2 <= "1" when (p_V_reg_174 = ap_const_lv3_4) else "0";
    ...
    m_axi_gmem_C_AWADDR <= sext_ln37827_fu_195_p1;
    ...
    m_axi_gmem_C_WDATA <= (((v1_V_reg_309 & v2_V_15492_reg_304) & v2_V_15491_reg_299) & v2_V_reg_294);
    ...
    begin
        ...
        sext_ln37827_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln37827_1_reg_242),64));
