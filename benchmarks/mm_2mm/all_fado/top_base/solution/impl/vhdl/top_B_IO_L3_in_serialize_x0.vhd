...
attribute shreg_extract : string;
    ...
    signal trunc_ln1407_1_reg_130 : STD_LOGIC_VECTOR (57 downto 0);
    signal i_V_4_fu_118_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal i_V_4_reg_141 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal fifo_data_reg_149 : STD_LOGIC_VECTOR (511 downto 0);
    signal i_V_reg_87 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal sext_ln1407_fu_108_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln1405_fu_124_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln1405_fu_124_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state74) and (fifo_B_local_out_full_n = ap_const_logic_1))) then 
                i_V_reg_87 <= i_V_4_reg_141;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                i_V_reg_87 <= ap_const_lv20_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln1407_1_reg_130 <= B_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_B_ARREADY, m_axi_gmem_B_RVALID, fifo_B_local_out_full_n, B_empty_n, ap_CS_fsm_state2, ap_CS_fsm_state73, ap_CS_fsm_state74, ap_CS_fsm_state72, icmp_ln1405_fu_124_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state72 => 
                if (((icmp_ln1405_fu_124_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state72, icmp_ln1405_fu_124_p2)
    begin
        if (((icmp_ln1405_fu_124_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state72, icmp_ln1405_fu_124_p2)
    begin
        if (((icmp_ln1405_fu_124_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state72))) then 
    ...
    fifo_B_local_out_blk_n_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state74)
    begin
    ...
    fifo_B_local_out_din <= fifo_data_reg_149;

    fifo_B_local_out_write_assign_proc : process(fifo_B_local_out_full_n, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) and (fifo_B_local_out_full_n = ap_const_logic_1))) then 
    ...
    i_V_4_fu_118_p2 <= std_logic_vector(unsigned(i_V_reg_87) + unsigned(ap_const_lv20_1));
    icmp_ln1405_fu_124_p2 <= "1" when (i_V_reg_87 = ap_const_lv20_80000) else "0";
    m_axi_gmem_B_ARADDR <= sext_ln1407_fu_108_p1;
    m_axi_gmem_B_ARBURST <= ap_const_lv2_0;
    m_axi_gmem_B_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem_B_ARID <= ap_const_lv1_0;
    m_axi_gmem_B_ARLEN <= ap_const_lv32_80000;
    ...
    m_axi_gmem_B_WVALID <= ap_const_logic_0;
        sext_ln1407_fu_108_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln1407_1_reg_130),64));
