...
module top_C_drain_IO_L3_out_serialize_x1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    C_blk_n;
reg   [57:0] trunc_ln37827_1_reg_242;
wire   [15:0] i_V_1_fu_205_p2;
reg   [15:0] i_V_1_reg_273;
...
reg   [127:0] v2_V_15491_reg_299;
reg   [127:0] v2_V_15492_reg_304;
...
reg   [15:0] i_V_reg_163;
reg   [2:0] p_V_reg_174;
wire   [0:0] icmp_ln37818_fu_211_p2;
wire  signed [63:0] sext_ln37827_fu_195_p1;
reg    ap_block_state1;
wire   [0:0] icmp_ln878_fu_227_p2;
reg   [75:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln37818_fu_211_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        p_V_reg_174 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln37827_1_reg_242 <= {{C_dout[63:6]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        v2_V_15492_reg_304 <= mem_data_split_V_q0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        v2_V_15491_reg_299 <= mem_data_split_V_q0;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln878_fu_227_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign i_V_1_fu_205_p2 = (i_V_reg_163 + 16'd1);

assign icmp_ln37818_fu_211_p2 = ((i_V_reg_163 == 16'd32768) ? 1'b1 : 1'b0);

assign icmp_ln878_fu_227_p2 = ((p_V_reg_174 == 3'd4) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_C_AWADDR = sext_ln37827_fu_195_p1;
...
assign m_axi_gmem_C_AWLEN = 32'd32768;
...
assign m_axi_gmem_C_WDATA = {{{{v1_V_reg_309}, {v2_V_15492_reg_304}}, {v2_V_15491_reg_299}}, {v2_V_reg_294}};
...
assign sext_ln37827_fu_195_p1 = $signed(trunc_ln37827_1_reg_242);
...
endmodule //top_C_drain_IO_L3_out_serialize_x1
