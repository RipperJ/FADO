...
attribute shreg_extract : string;
    ...
    signal add_ln691_965_fu_175_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_965_reg_261 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal icmp_ln890_710_fu_187_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_969_fu_199_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_969_reg_276 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal add_ln691_967_fu_211_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_967_reg_284 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_966_fu_223_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln890_711_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln890_712_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_970_fu_229_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_970_reg_297 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal add_ln691_968_fu_241_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_968_reg_305 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal c0_V_reg_85 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln890_709_fu_181_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln890_714_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c4_V_reg_130 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln890_713_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_709_fu_181_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_710_fu_187_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (((icmp_ln890_711_fu_217_p2 = ap_const_lv1_1) and (icmp_ln870_reg_272 = ap_const_lv1_1)) or ((icmp_ln870_reg_272 = ap_const_lv1_0) and (icmp_ln890_712_fu_205_p2 = ap_const_lv1_1))))) then 
                c3_V_reg_107 <= add_ln691_966_fu_223_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_709_fu_181_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_710_fu_187_p2 = ap_const_lv1_0) and (icmp_ln870_fu_193_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                c4_V_10_reg_119 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_714_fu_235_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_710_fu_187_p2 = ap_const_lv1_0) and (icmp_ln870_fu_193_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                c4_V_reg_130 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_713_fu_247_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln870_reg_272 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln890_712_fu_205_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_711_fu_217_p2 = ap_const_lv1_0) and (icmp_ln870_reg_272 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_710_fu_187_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                icmp_ln870_reg_272 <= icmp_ln870_fu_193_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_C_drain_C_drain_IO_L2_out_3_x0295_empty_n, fifo_C_drain_C_drain_IO_L2_out_2_x0294_full_n, fifo_C_drain_C_drain_IO_L1_out_2_0_x0244_empty_n, ap_CS_fsm_state7, ap_CS_fsm_state9, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln870_reg_272, ap_CS_fsm_state4, icmp_ln890_710_fu_187_p2, ap_CS_fsm_state5, icmp_ln890_711_fu_217_p2, icmp_ln890_712_fu_205_p2, ap_CS_fsm_state6, ap_CS_fsm_state8, icmp_ln890_709_fu_181_p2, icmp_ln890_fu_169_p2, icmp_ln890_714_fu_235_p2, icmp_ln890_713_fu_247_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_709_fu_181_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state4 => 
                if (((icmp_ln890_710_fu_187_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (((icmp_ln890_711_fu_217_p2 = ap_const_lv1_1) and (icmp_ln870_reg_272 = ap_const_lv1_1)) or ((icmp_ln870_reg_272 = ap_const_lv1_0) and (icmp_ln890_712_fu_205_p2 = ap_const_lv1_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                elsif (((icmp_ln890_711_fu_217_p2 = ap_const_lv1_0) and (icmp_ln870_reg_272 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                else
                    ap_NS_fsm <= ap_ST_fsm_state6;
                end if;
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_714_fu_235_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
            ...
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_713_fu_247_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
    ...
    add_ln691_965_fu_175_p2 <= std_logic_vector(unsigned(c1_V_reg_96) + unsigned(ap_const_lv5_1));
    add_ln691_966_fu_223_p2 <= std_logic_vector(unsigned(c3_V_reg_107) + unsigned(ap_const_lv4_1));
    add_ln691_967_fu_211_p2 <= std_logic_vector(unsigned(c4_V_reg_130) + unsigned(ap_const_lv4_1));
    add_ln691_968_fu_241_p2 <= std_logic_vector(unsigned(c5_V_reg_152) + unsigned(ap_const_lv4_1));
    add_ln691_969_fu_199_p2 <= std_logic_vector(unsigned(c4_V_10_reg_119) + unsigned(ap_const_lv4_1));
    add_ln691_970_fu_229_p2 <= std_logic_vector(unsigned(c5_V_10_reg_141) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln890_709_fu_181_p2 <= "1" when (c1_V_reg_96 = ap_const_lv5_10) else "0";
    icmp_ln890_710_fu_187_p2 <= "1" when (c3_V_reg_107 = ap_const_lv4_8) else "0";
    icmp_ln890_711_fu_217_p2 <= "1" when (c4_V_reg_130 = ap_const_lv4_8) else "0";
    icmp_ln890_712_fu_205_p2 <= "1" when (c4_V_10_reg_119 = ap_const_lv4_8) else "0";
    icmp_ln890_713_fu_247_p2 <= "1" when (c5_V_reg_152 = ap_const_lv4_8) else "0";
    icmp_ln890_714_fu_235_p2 <= "1" when (c5_V_10_reg_141 = ap_const_lv4_8) else "0";
