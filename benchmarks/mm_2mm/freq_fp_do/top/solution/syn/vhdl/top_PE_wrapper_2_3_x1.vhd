...
attribute shreg_extract : string;
    ...
    signal empty_3360_reg_871 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal empty_3359_fu_975_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    mac_muladd_16s_16s_16ns_16_4_1_U1185 : component top_mac_muladd_16s_16s_16ns_16_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    empty_3360_reg_871_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
    ...
    empty_3359_fu_975_p2 <= std_logic_vector(unsigned(tmp_215_cast_fu_967_p3) + unsigned(zext_ln890_reg_1526));
    ...
    fifo_C_drain_PE_2_3_x1190_din <= empty_3360_reg_871;
    ...
    local_C_d0_assign_proc : process(ap_CS_fsm_state11, ap_CS_fsm_state8, empty_3360_reg_871)
    begin
    ...
    p_cast_fu_980_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_3359_fu_975_p2),64));
