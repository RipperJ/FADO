...
wire   [4:0] add_ln691_983_fu_170_p2;
reg   [4:0] add_ln691_983_reg_256;
wire    ap_CS_fsm_state3;
wire   [3:0] add_ln691_984_fu_182_p2;
reg   [3:0] add_ln691_984_reg_264;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln870_fu_194_p2;
reg   [0:0] icmp_ln870_reg_272;
wire   [0:0] icmp_ln890_728_fu_188_p2;
wire   [3:0] add_ln691_987_fu_200_p2;
reg   [3:0] add_ln691_987_reg_276;
wire    ap_CS_fsm_state5;
wire   [3:0] add_ln691_985_fu_212_p2;
reg   [3:0] add_ln691_985_reg_284;
wire   [3:0] add_ln691_988_fu_224_p2;
reg   [3:0] add_ln691_988_reg_292;
wire    ap_CS_fsm_state6;
wire   [3:0] add_ln691_986_fu_236_p2;
reg   [3:0] add_ln691_986_reg_300;
wire    ap_CS_fsm_state8;
reg   [4:0] c0_V_reg_81;
wire   [0:0] icmp_ln890_727_fu_176_p2;
reg    ap_block_state1;
reg   [4:0] c1_V_reg_92;
wire   [0:0] icmp_ln890_fu_164_p2;
reg   [3:0] c3_V_reg_103;
wire   [0:0] icmp_ln890_729_fu_218_p2;
wire   [0:0] icmp_ln890_730_fu_206_p2;
reg   [3:0] c4_V_13_reg_114;
wire   [0:0] icmp_ln890_732_fu_230_p2;
reg   [3:0] c4_V_reg_125;
wire   [0:0] icmp_ln890_731_fu_242_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_81 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_727_fu_176_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_164_p2 == 1'd0))) begin
        c1_V_reg_92 <= 5'd0;
    end else if (((icmp_ln890_728_fu_188_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c1_V_reg_92 <= add_ln691_983_reg_256;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln870_reg_272 == 1'd1) & (icmp_ln890_729_fu_218_p2 == 1'd1)) | ((icmp_ln870_reg_272 == 1'd0) & (icmp_ln890_730_fu_206_p2 == 1'd1))))) begin
        c3_V_reg_103 <= add_ln691_984_reg_264;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_727_fu_176_p2 == 1'd0))) begin
        c3_V_reg_103 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_728_fu_188_p2 == 1'd0) & (icmp_ln870_fu_194_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        c4_V_13_reg_114 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_732_fu_230_p2 == 1'd1))) begin
        c4_V_13_reg_114 <= add_ln691_987_reg_276;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_728_fu_188_p2 == 1'd0) & (icmp_ln870_fu_194_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c4_V_reg_125 <= 4'd0;
    end else if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_731_fu_242_p2 == 1'd1))) begin
        c4_V_reg_125 <= add_ln691_985_reg_284;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln870_reg_272 == 1'd0) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_730_fu_206_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln870_reg_272 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_729_fu_218_p2 == 1'd0))) begin
        c5_V_reg_147 <= 4'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_728_fu_188_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln890_727_fu_176_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln890_728_fu_188_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln870_reg_272 == 1'd1) & (icmp_ln890_729_fu_218_p2 == 1'd1)) | ((icmp_ln870_reg_272 == 1'd0) & (icmp_ln890_730_fu_206_p2 == 1'd1))))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if (((icmp_ln870_reg_272 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_729_fu_218_p2 == 1'd0))) begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_732_fu_230_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (icmp_ln890_731_fu_242_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
...
assign add_ln691_983_fu_170_p2 = (c1_V_reg_92 + 5'd1);

assign add_ln691_984_fu_182_p2 = (c3_V_reg_103 + 4'd1);

assign add_ln691_985_fu_212_p2 = (c4_V_reg_125 + 4'd1);

assign add_ln691_986_fu_236_p2 = (c5_V_reg_147 + 4'd1);

assign add_ln691_987_fu_200_p2 = (c4_V_13_reg_114 + 4'd1);

assign add_ln691_988_fu_224_p2 = (c5_V_13_reg_136 + 4'd1);
...
assign icmp_ln890_727_fu_176_p2 = ((c1_V_reg_92 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_728_fu_188_p2 = ((c3_V_reg_103 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_729_fu_218_p2 = ((c4_V_reg_125 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_730_fu_206_p2 = ((c4_V_13_reg_114 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_731_fu_242_p2 = ((c5_V_reg_147 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_732_fu_230_p2 = ((c5_V_13_reg_136 == 4'd8) ? 1'b1 : 1'b0);
