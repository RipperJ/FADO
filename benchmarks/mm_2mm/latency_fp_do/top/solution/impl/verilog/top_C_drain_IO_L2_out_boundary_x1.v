...
wire   [4:0] add_ln691_905_fu_122_p2;
reg   [4:0] add_ln691_905_reg_166;
wire    ap_CS_fsm_state3;
wire   [3:0] add_ln691_906_fu_134_p2;
reg   [3:0] add_ln691_906_reg_174;
wire    ap_CS_fsm_state4;
wire   [3:0] add_ln691_907_fu_146_p2;
reg   [3:0] add_ln691_907_reg_182;
wire    ap_CS_fsm_state5;
reg   [4:0] c0_V_reg_66;
wire   [0:0] icmp_ln890_649_fu_128_p2;
reg    ap_block_state1;
reg   [4:0] c1_V_reg_77;
wire   [0:0] icmp_ln890_650_fu_140_p2;
wire   [0:0] icmp_ln890_fu_116_p2;
reg   [3:0] c4_V_reg_88;
wire   [0:0] icmp_ln890_651_fu_152_p2;
reg   [3:0] c5_V_reg_99;
reg    ap_block_state6;
reg   [5:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_66 <= 5'd0;
    end else if (((icmp_ln890_649_fu_128_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_116_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        c1_V_reg_77 <= 5'd0;
    end else if (((icmp_ln890_650_fu_140_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c1_V_reg_77 <= add_ln691_905_reg_166;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_649_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c4_V_reg_88 <= 4'd0;
    end else if (((icmp_ln890_651_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        c4_V_reg_88 <= add_ln691_906_reg_174;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_650_fu_140_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        c5_V_reg_99 <= 4'd0;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_649_fu_128_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln890_650_fu_140_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (((icmp_ln890_651_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else begin
...
assign add_ln691_905_fu_122_p2 = (c1_V_reg_77 + 5'd1);

assign add_ln691_906_fu_134_p2 = (c4_V_reg_88 + 4'd1);

assign add_ln691_907_fu_146_p2 = (c5_V_reg_99 + 4'd1);
...
assign icmp_ln890_649_fu_128_p2 = ((c1_V_reg_77 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_650_fu_140_p2 = ((c4_V_reg_88 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln890_651_fu_152_p2 = ((c5_V_reg_99 == 4'd8) ? 1'b1 : 1'b0);
