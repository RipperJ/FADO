...
attribute shreg_extract : string;
    ...
    signal kernel0_x0_entry13_U0_ap_start : STD_LOGIC;
    signal kernel0_x0_entry13_U0_ap_done : STD_LOGIC;
    signal kernel0_x0_entry13_U0_ap_continue : STD_LOGIC;
    signal kernel0_x0_entry13_U0_ap_idle : STD_LOGIC;
    signal kernel0_x0_entry13_U0_ap_ready : STD_LOGIC;
    signal kernel0_x0_entry13_U0_B_read : STD_LOGIC;
    signal kernel0_x0_entry13_U0_B_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel0_x0_entry13_U0_B_out_write : STD_LOGIC;
    signal ap_sync_reg_kernel0_x0_entry13_U0_ap_start : STD_LOGIC := '0';
    ...
    component top_kernel0_x0_entry13 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    kernel0_x0_entry13_U0 : component top_kernel0_x0_entry13
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => kernel0_x0_entry13_U0_ap_start,
        ap_done => kernel0_x0_entry13_U0_ap_done,
        ap_continue => kernel0_x0_entry13_U0_ap_continue,
        ap_idle => kernel0_x0_entry13_U0_ap_idle,
        ap_ready => kernel0_x0_entry13_U0_ap_ready,
        B_dout => B_c1_dout,
    ...
    ap_sync_reg_kernel0_x0_entry13_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel0_x0_entry13_U0_ap_start <= ap_const_logic_0;
            else
                if ((ap_start = ap_const_logic_1)) then 
                    ap_sync_reg_kernel0_x0_entry13_U0_ap_start <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_ready <= (ap_sync_kernel0_x0_entry3_U0_ap_ready and ap_sync_B_IO_L3_in_serialize_x0_U0_ap_ready and ap_sync_A_IO_L3_in_serialize_x0_U0_ap_ready);
    kernel0_x0_entry13_U0_ap_continue <= ap_const_logic_1;
    kernel0_x0_entry13_U0_ap_start <= (ap_sync_reg_kernel0_x0_entry13_U0_ap_start or ap_start);
