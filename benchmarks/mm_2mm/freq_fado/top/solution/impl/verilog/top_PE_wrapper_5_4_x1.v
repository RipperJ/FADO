...
wire   [3:0] add_ln691_138_fu_1304_p2;
reg   [3:0] add_ln691_138_reg_1902;
...
wire   [3:0] add_ln691_134_fu_1146_p2;
wire   [2:0] empty_2803_fu_1184_p1;
wire   [5:0] tmp_80_cast_fu_1188_p3;
wire   [5:0] zext_ln890_fu_1180_p1;
wire   [5:0] empty_2804_fu_1196_p2;
...
top_mac_muladd_16s_16s_16ns_16_4_1 #(
    ...
    .din2_WIDTH( 16 ),
    .dout_WIDTH( 16 ))
mac_muladd_16s_16s_16ns_16_4_1_U3514(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(local_B_0_q0),
    .din1(local_A_0_q0),
...
assign add_ln691_134_fu_1146_p2 = (select_ln29467_fu_1090_p3 + 4'd1);

assign add_ln691_135_fu_1207_p2 = (n_V_reg_877 + 6'd1);

assign add_ln691_136_fu_1243_p2 = (n_V_20_reg_897 + 6'd1);

assign add_ln691_137_fu_1286_p2 = (c8_V_reg_917 + 6'd1);

assign add_ln691_138_fu_1304_p2 = (select_ln890_191_reg_1821 + 4'd1);
...
assign empty_2803_fu_1184_p1 = select_ln890_191_fu_1164_p3[2:0];

assign empty_2804_fu_1196_p2 = (tmp_80_cast_fu_1188_p3 + zext_ln890_fu_1180_p1);
...
assign p_cast_fu_1202_p1 = empty_2804_fu_1196_p2;
...
assign select_ln890_192_fu_1172_p3 = ((and_ln29467_fu_1132_p2[0:0] == 1'b1) ? add_ln691_134_fu_1146_p2 : select_ln29467_fu_1090_p3);
...
assign tmp_80_cast_fu_1188_p3 = {{empty_2803_fu_1184_p1}, {3'd0}};
