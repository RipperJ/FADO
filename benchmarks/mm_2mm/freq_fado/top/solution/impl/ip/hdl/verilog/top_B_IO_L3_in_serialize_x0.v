...
reg    B_blk_n;
reg   [57:0] trunc_ln1407_1_reg_130;
wire   [19:0] i_V_4_fu_118_p2;
reg   [19:0] i_V_4_reg_141;
wire    ap_CS_fsm_state72;
reg   [511:0] fifo_data_reg_149;
reg   [19:0] i_V_reg_87;
wire    ap_CS_fsm_state71;
wire  signed [63:0] sext_ln1407_fu_108_p1;
reg    ap_block_state1;
wire   [0:0] icmp_ln1405_fu_124_p2;
reg   [73:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln1405_fu_124_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state72))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state74) & (fifo_B_local_out_full_n == 1'b1))) begin
        i_V_reg_87 <= i_V_4_reg_141;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state73)) begin
        fifo_data_reg_149 <= m_axi_gmem_B_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state72)) begin
        i_V_4_reg_141 <= i_V_4_fu_118_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln1407_1_reg_130 <= {{B_dout[63:6]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln1405_fu_124_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state72))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign fifo_B_local_out_din = fifo_data_reg_149;

assign i_V_4_fu_118_p2 = (i_V_reg_87 + 20'd1);

assign icmp_ln1405_fu_124_p2 = ((i_V_reg_87 == 20'd524288) ? 1'b1 : 1'b0);

assign m_axi_gmem_B_ARADDR = sext_ln1407_fu_108_p1;
...
assign m_axi_gmem_B_ARLEN = 32'd524288;
...
assign sext_ln1407_fu_108_p1 = $signed(trunc_ln1407_1_reg_130);
