...
wire   [4:0] add_ln691_459_fu_122_p2;
reg   [4:0] add_ln691_459_reg_166;
wire    ap_CS_fsm_state3;
wire   [3:0] add_ln691_460_fu_134_p2;
reg   [3:0] add_ln691_460_reg_174;
wire    ap_CS_fsm_state4;
wire   [3:0] add_ln691_461_fu_146_p2;
reg   [3:0] add_ln691_461_reg_182;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_fu_116_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        c1_V_reg_77 <= add_ln691_459_reg_166;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_458_fu_128_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        c4_V_reg_88 <= add_ln691_460_reg_174;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_459_fu_140_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ...
        c5_V_reg_99 <= add_ln691_461_reg_182;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_459_reg_166 <= add_ln691_459_fu_122_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        add_ln691_460_reg_174 <= add_ln691_460_fu_134_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        add_ln691_461_reg_182 <= add_ln691_461_fu_146_p2;
    end
end
...
assign add_ln691_459_fu_122_p2 = (c1_V_reg_77 + 5'd1);

assign add_ln691_460_fu_134_p2 = (c4_V_reg_88 + 4'd1);

assign add_ln691_461_fu_146_p2 = (c5_V_reg_99 + 4'd1);
