...
wire   [19:0] add_ln890_fu_75_p2;
reg   [19:0] add_ln890_reg_87;
wire    ap_CS_fsm_state2;
reg   [19:0] indvar_flatten59_reg_64;
reg    ap_block_state1;
reg    ap_block_state3;
...
always @ (posedge ap_clk) begin
    if ((~((fifo_B_local_out_full_n == 1'b0) | (fifo_B_in_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
        indvar_flatten59_reg_64 <= add_ln890_reg_87;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        indvar_flatten59_reg_64 <= 20'd0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln890_fu_81_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln890_fu_75_p2 = (indvar_flatten59_reg_64 + 20'd1);
...
always @ (*) begin
    ap_block_state3 = ((fifo_B_local_out_full_n == 1'b0) | (fifo_B_in_empty_n == 1'b0));
end

assign fifo_B_local_out_din = fifo_B_in_dout;

assign icmp_ln890_fu_81_p2 = ((indvar_flatten59_reg_64 == 20'd524288) ? 1'b1 : 1'b0);
