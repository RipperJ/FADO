...
attribute shreg_extract : string;
    signal kernel0_x0_entry83_U0_ap_start : STD_LOGIC;
    signal kernel0_x0_entry83_U0_ap_done : STD_LOGIC;
    signal kernel0_x0_entry83_U0_ap_continue : STD_LOGIC;
    signal kernel0_x0_entry83_U0_ap_idle : STD_LOGIC;
    signal kernel0_x0_entry83_U0_ap_ready : STD_LOGIC;
    signal kernel0_x0_entry83_U0_B_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel0_x0_entry83_U0_B_out_write : STD_LOGIC;
    signal kernel0_x0_entry19_U0_ap_start : STD_LOGIC;
    signal kernel0_x0_entry19_U0_ap_done : STD_LOGIC;
    signal kernel0_x0_entry19_U0_ap_continue : STD_LOGIC;
    signal kernel0_x0_entry19_U0_ap_idle : STD_LOGIC;
    signal kernel0_x0_entry19_U0_ap_ready : STD_LOGIC;
    signal kernel0_x0_entry19_U0_B_read : STD_LOGIC;
    signal kernel0_x0_entry19_U0_B_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal kernel0_x0_entry19_U0_B_out_write : STD_LOGIC;
    signal ap_sync_reg_kernel0_x0_entry19_U0_ap_start : STD_LOGIC := '0';
    ...
    signal A_IO_L3_in_serialize_x0_U0_A_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal B_IO_L3_in_serialize_x0_U0_fifo_B_local_out_din : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal C_drain_IO_L3_out_serialize_x0_U0_fifo_C_drain_C_drain_IO_L3_out_serialize_x03_read : STD_LOGIC;
    signal C_drain_IO_L3_out_serialize_x0_U0_C_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal C_drain_IO_L3_out_serialize_x0_U0_C_ce0 : STD_LOGIC;
    signal C_drain_IO_L3_out_serialize_x0_U0_C_we0 : STD_LOGIC;
    signal C_drain_IO_L3_out_serialize_x0_U0_C_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sync_reg_C_drain_IO_L3_out_serialize_x0_U0_ap_start : STD_LOGIC := '0';
    signal B_c1_full_n : STD_LOGIC;
    signal B_c1_dout : STD_LOGIC_VECTOR (63 downto 0);
    signal B_c1_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_kernel0_x0_entry83_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_kernel0_x0_entry83_U0_ap_ready : STD_LOGIC;
    ...
    component top_kernel0_x0_entry83 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component top_kernel0_x0_entry19 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    kernel0_x0_entry83_U0 : component top_kernel0_x0_entry83
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => kernel0_x0_entry83_U0_ap_start,
        ap_done => kernel0_x0_entry83_U0_ap_done,
        ap_continue => kernel0_x0_entry83_U0_ap_continue,
        ap_idle => kernel0_x0_entry83_U0_ap_idle,
        ap_ready => kernel0_x0_entry83_U0_ap_ready,
        B => B,
        B_out_din => kernel0_x0_entry83_U0_B_out_din,
        B_out_full_n => B_c1_full_n,
        B_out_write => kernel0_x0_entry83_U0_B_out_write);

    kernel0_x0_entry19_U0 : component top_kernel0_x0_entry19
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    B_c1_U : component top_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    ap_sync_reg_kernel0_x0_entry19_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel0_x0_entry19_U0_ap_start <= ap_const_logic_0;
            else
                if ((ap_start = ap_const_logic_1)) then 
                    ap_sync_reg_kernel0_x0_entry19_U0_ap_start <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_kernel0_x0_entry83_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_kernel0_x0_entry83_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_kernel0_x0_entry83_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_sync_kernel0_x0_entry83_U0_ap_ready <= (kernel0_x0_entry83_U0_ap_ready or ap_sync_reg_kernel0_x0_entry83_U0_ap_ready);
    ap_sync_ready <= (ap_sync_kernel0_x0_entry83_U0_ap_ready and ap_sync_B_IO_L3_in_serialize_x0_U0_ap_ready and ap_sync_A_IO_L3_in_serialize_x0_U0_ap_ready);
    kernel0_x0_entry19_U0_ap_continue <= ap_const_logic_1;
    kernel0_x0_entry19_U0_ap_start <= (ap_sync_reg_kernel0_x0_entry19_U0_ap_start or ap_start);
    kernel0_x0_entry83_U0_ap_continue <= ap_const_logic_1;
    kernel0_x0_entry83_U0_ap_start <= ((ap_sync_reg_kernel0_x0_entry83_U0_ap_ready xor ap_const_logic_1) and ap_start);
    m_axi_gmem_B_ARADDR <= B_IO_L3_in_serialize_x0_U0_m_axi_gmem_B_ARADDR;
    m_axi_gmem_B_ARBURST <= B_IO_L3_in_serialize_x0_U0_m_axi_gmem_B_ARBURST;
    m_axi_gmem_B_ARCACHE <= B_IO_L3_in_serialize_x0_U0_m_axi_gmem_B_ARCACHE;
    m_axi_gmem_B_ARID <= B_IO_L3_in_serialize_x0_U0_m_axi_gmem_B_ARID;
