...
attribute shreg_extract : string;
    ...
    signal add_ln691_713_fu_153_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln691_713_reg_229 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal icmp_ln890_569_fu_159_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_714_fu_185_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln691_714_reg_241 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal add_ln691_715_fu_197_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_715_reg_249 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal add_ln691_716_fu_209_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln691_716_reg_257 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal c0_V_reg_86 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal c1_V_reg_97 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln890_570_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln890_fu_147_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c4_V_reg_108 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln890_571_fu_203_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c5_V_reg_119 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln890_572_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_569_fu_159_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln886_reg_237 = ap_const_lv1_1) or (icmp_ln890_570_fu_191_p2 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_569_fu_159_p2 = ap_const_lv1_0) and (icmp_ln886_fu_179_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                c4_V_reg_108 <= ap_const_lv3_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln890_571_fu_203_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln886_reg_237 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln890_570_fu_191_p2 = ap_const_lv1_0))) then 
                c5_V_reg_119 <= ap_const_lv5_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_572_fu_215_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln890_571_fu_203_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_569_fu_159_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                icmp_ln886_reg_237 <= icmp_ln886_fu_179_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_D_drain_D_drain_IO_L2_out_7_x1212_full_n, fifo_D_drain_D_drain_IO_L1_out_7_0_x1201_empty_n, ap_CS_fsm_state7, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln886_reg_237, icmp_ln890_569_fu_159_p2, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, icmp_ln890_570_fu_191_p2, icmp_ln890_fu_147_p2, icmp_ln890_571_fu_203_p2, icmp_ln890_572_fu_215_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((icmp_ln890_569_fu_159_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and ((icmp_ln886_reg_237 = ap_const_lv1_1) or (icmp_ln890_570_fu_191_p2 = ap_const_lv1_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state5;
                end if;
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln890_571_fu_203_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                else
                    ap_NS_fsm <= ap_ST_fsm_state6;
                end if;
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_572_fu_215_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
    ...
    add_ln691_713_fu_153_p2 <= std_logic_vector(unsigned(c1_V_reg_97) + unsigned(ap_const_lv3_1));
    add_ln691_714_fu_185_p2 <= std_logic_vector(unsigned(c4_V_reg_108) + unsigned(ap_const_lv3_1));
    add_ln691_715_fu_197_p2 <= std_logic_vector(unsigned(c5_V_reg_119) + unsigned(ap_const_lv5_1));
    add_ln691_716_fu_209_p2 <= std_logic_vector(unsigned(c6_V_reg_130) + unsigned(ap_const_lv2_1));
    ...
    icmp_ln890_569_fu_159_p2 <= "1" when (c1_V_reg_97 = ap_const_lv3_6) else "0";
    icmp_ln890_570_fu_191_p2 <= "1" when (c4_V_reg_108 = ap_const_lv3_4) else "0";
    icmp_ln890_571_fu_203_p2 <= "1" when (c5_V_reg_119 = ap_const_lv5_10) else "0";
    icmp_ln890_572_fu_215_p2 <= "1" when (c6_V_reg_130 = ap_const_lv2_2) else "0";
