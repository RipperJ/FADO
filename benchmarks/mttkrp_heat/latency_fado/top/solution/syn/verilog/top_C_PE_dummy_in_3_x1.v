...
wire   [2:0] add_ln691_1395_fu_191_p2;
reg   [2:0] add_ln691_1395_reg_291;
...
wire   [1:0] add_ln691_1397_fu_235_p2;
reg   [1:0] add_ln691_1397_reg_311;
wire    ap_CS_fsm_state5;
wire   [5:0] add_ln691_1398_fu_247_p2;
reg   [5:0] add_ln691_1398_reg_319;
wire    ap_CS_fsm_state6;
wire   [3:0] add_ln691_1399_fu_259_p2;
reg   [3:0] add_ln691_1399_reg_327;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_1400_fu_271_p2;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln890_1236_reg_299 == 1'd0) | (icmp_ln22875_fu_229_p2 == 1'd1)))) begin
        c1_V_reg_113 <= add_ln691_1395_reg_291;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_1236_reg_299 == 1'd1) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln22875_fu_229_p2 == 1'd0))) begin
        c5_V_reg_135 <= 2'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1238_fu_253_p2 == 1'd1))) begin
        c5_V_reg_135 <= add_ln691_1397_reg_311;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_1237_fu_241_p2 == 1'd0))) begin
        ...
        c6_V_reg_146 <= add_ln691_1398_reg_319;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1238_fu_253_p2 == 1'd0))) begin
        ...
        c7_V_reg_157 <= add_ln691_1399_reg_327;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_1239_fu_265_p2 == 1'd0))) begin
        ...
        c8_V_reg_168 <= add_ln691_1400_fu_271_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_1395_reg_291 <= add_ln691_1395_fu_191_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        add_ln691_1397_reg_311 <= add_ln691_1397_fu_235_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_1398_reg_319 <= add_ln691_1398_fu_247_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        add_ln691_1399_reg_327 <= add_ln691_1399_fu_259_p2;
    end
end
...
assign add_ln691_1395_fu_191_p2 = (c1_V_reg_113 + 3'd1);

assign add_ln691_1397_fu_235_p2 = (c5_V_reg_135 + 2'd1);

assign add_ln691_1398_fu_247_p2 = (c6_V_reg_146 + 6'd1);

assign add_ln691_1399_fu_259_p2 = (c7_V_reg_157 + 4'd1);

assign add_ln691_1400_fu_271_p2 = (c8_V_reg_168 + 5'd1);
