set moduleName kernel0_x1_entry15
set isTopModule 0
...
set C_modelName {kernel0_x1.entry15}
...
set portList { 
	...
	{ D_dout sc_in sc_lv 64 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "D_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "29", "DependentChanType" : "2",
				"BlockSignal" : [
