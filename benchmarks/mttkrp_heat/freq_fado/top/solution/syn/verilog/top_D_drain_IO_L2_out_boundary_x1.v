...
wire   [2:0] add_ln691_379_fu_153_p2;
reg   [2:0] add_ln691_379_reg_229;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln886_fu_179_p2;
reg   [0:0] icmp_ln886_reg_237;
wire   [0:0] icmp_ln890_444_fu_159_p2;
wire   [2:0] add_ln691_380_fu_185_p2;
reg   [2:0] add_ln691_380_reg_241;
wire    ap_CS_fsm_state4;
wire   [4:0] add_ln691_381_fu_197_p2;
reg   [4:0] add_ln691_381_reg_249;
wire    ap_CS_fsm_state5;
wire   [1:0] add_ln691_382_fu_209_p2;
reg   [1:0] add_ln691_382_reg_257;
wire    ap_CS_fsm_state6;
reg   [2:0] c0_V_reg_86;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_97;
wire   [0:0] icmp_ln890_445_fu_191_p2;
wire   [0:0] icmp_ln890_fu_147_p2;
reg   [2:0] c4_V_reg_108;
wire   [0:0] icmp_ln890_446_fu_203_p2;
reg   [4:0] c5_V_reg_119;
wire   [0:0] icmp_ln890_447_fu_215_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_86 <= 3'd0;
    end else if (((icmp_ln890_444_fu_159_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_147_p2 == 1'd0))) begin
        c1_V_reg_97 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_reg_237 == 1'd1) | (icmp_ln890_445_fu_191_p2 == 1'd1)))) begin
        c1_V_reg_97 <= add_ln691_379_reg_229;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_444_fu_159_p2 == 1'd0) & (icmp_ln886_fu_179_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c4_V_reg_108 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_446_fu_203_p2 == 1'd1))) begin
        c4_V_reg_108 <= add_ln691_380_reg_241;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln886_reg_237 == 1'd0) & (1'b1 == ap_CS_fsm_state4) & (icmp_ln890_445_fu_191_p2 == 1'd0))) begin
        c5_V_reg_119 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_447_fu_215_p2 == 1'd1))) begin
        c5_V_reg_119 <= add_ln691_381_reg_249;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_446_fu_203_p2 == 1'd0))) begin
        c6_V_reg_130 <= 2'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_444_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_444_fu_159_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_reg_237 == 1'd1) | (icmp_ln890_445_fu_191_p2 == 1'd1)))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln890_446_fu_203_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_447_fu_215_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
...
assign add_ln691_379_fu_153_p2 = (c1_V_reg_97 + 3'd1);

assign add_ln691_380_fu_185_p2 = (c4_V_reg_108 + 3'd1);

assign add_ln691_381_fu_197_p2 = (c5_V_reg_119 + 5'd1);

assign add_ln691_382_fu_209_p2 = (c6_V_reg_130 + 2'd1);
...
assign icmp_ln890_444_fu_159_p2 = ((c1_V_reg_97 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln890_445_fu_191_p2 = ((c4_V_reg_108 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln890_446_fu_203_p2 = ((c5_V_reg_119 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_447_fu_215_p2 = ((c6_V_reg_130 == 2'd2) ? 1'b1 : 1'b0);
