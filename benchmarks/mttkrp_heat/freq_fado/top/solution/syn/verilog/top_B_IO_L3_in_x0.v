...
wire   [2:0] add_ln691_1454_fu_161_p2;
reg   [2:0] add_ln691_1454_reg_240;
wire    ap_CS_fsm_state3;
wire   [5:0] add_i_i35_cast_fu_181_p2;
reg   [5:0] add_i_i35_cast_reg_248;
wire   [0:0] icmp_ln890_1542_fu_167_p2;
wire   [7:0] c2_V_100_fu_187_p2;
reg   [7:0] c2_V_100_reg_253;
wire    ap_CS_fsm_state4;
wire   [3:0] c3_62_fu_205_p2;
reg   [3:0] c3_62_reg_264;
wire    ap_CS_fsm_state5;
wire   [1:0] add_ln691_1456_fu_220_p2;
reg   [1:0] add_ln691_1456_reg_272;
wire    ap_CS_fsm_state6;
reg   [2:0] c0_V_reg_94;
reg    ap_block_state1;
reg   [2:0] c1_V_reg_105;
wire   [0:0] icmp_ln1022_fu_193_p2;
wire   [0:0] icmp_ln890_fu_155_p2;
reg   [7:0] c2_V_reg_116;
wire   [0:0] icmp_ln886_fu_215_p2;
wire   [0:0] icmp_ln1025_fu_199_p2;
reg   [3:0] c3_reg_127;
wire   [0:0] icmp_ln890_1543_fu_226_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_94 <= 3'd0;
    end else if (((icmp_ln890_1542_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_155_p2 == 1'd0))) begin
        c1_V_reg_105 <= 3'd0;
    end else if (((icmp_ln1022_fu_193_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c1_V_reg_105 <= add_ln691_1454_reg_240;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & ((icmp_ln1025_fu_199_p2 == 1'd1) | (icmp_ln886_fu_215_p2 == 1'd1)))) begin
        c2_V_reg_116 <= c2_V_100_reg_253;
    end else if (((icmp_ln890_1542_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c2_V_reg_116 <= 8'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1543_fu_226_p2 == 1'd1))) begin
        c3_reg_127 <= c3_62_reg_264;
    end else if (((icmp_ln1022_fu_193_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        c3_reg_127 <= 4'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln1025_fu_199_p2 == 1'd0) & (icmp_ln886_fu_215_p2 == 1'd0))) begin
        c4_V_reg_138 <= 2'd0;
    end else if ((~((fifo_B_local_out_full_n == 1'b0) | (fifo_B_in_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state7))) begin
        c4_V_reg_138 <= add_ln691_1456_reg_272;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_1542_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_1454_reg_240 <= add_ln691_1454_fu_161_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_1456_reg_272 <= add_ln691_1456_fu_220_p2;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_1542_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state4 : begin
            if (((icmp_ln1022_fu_193_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
...
assign add_ln691_1454_fu_161_p2 = (c1_V_reg_105 + 3'd1);

assign add_ln691_1456_fu_220_p2 = (c4_V_reg_138 + 2'd1);
...
assign c2_V_100_fu_187_p2 = (c2_V_reg_116 + 8'd1);

assign c3_62_fu_205_p2 = (c3_reg_127 + 4'd1);

assign fifo_B_local_out_din = fifo_B_in_dout;

assign icmp_ln1022_fu_193_p2 = ((c2_V_reg_116 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln1025_fu_199_p2 = ((c3_reg_127 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln886_fu_215_p2 = ((zext_ln886_fu_211_p1 > add_i_i35_cast_reg_248) ? 1'b1 : 1'b0);

assign icmp_ln890_1542_fu_167_p2 = ((c1_V_reg_105 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln890_1543_fu_226_p2 = ((c4_V_reg_138 == 2'd2) ? 1'b1 : 1'b0);
