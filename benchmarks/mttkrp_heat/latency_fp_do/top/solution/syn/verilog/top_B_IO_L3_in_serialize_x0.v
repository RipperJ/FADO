...
wire   [0:0] icmp_ln878_100_fu_172_p2;
reg    B_blk_n;
...
always @ (posedge ap_clk) begin
    if ((~((icmp_ln878_100_fu_172_p2 == 1'd0) & (fifo_B_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_100_fu_172_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state74)) begin
        p_V_reg_114 <= 2'd0;
    end else if ((~((icmp_ln878_100_fu_172_p2 == 1'd0) & (fifo_B_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_100_fu_172_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state75) & (icmp_ln878_100_fu_172_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((~((icmp_ln878_100_fu_172_p2 == 1'd0) & (fifo_B_local_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state75) & (icmp_ln878_100_fu_172_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_state75 = ((icmp_ln878_100_fu_172_p2 == 1'd0) & (fifo_B_local_out_full_n == 1'b0));
end
...
assign icmp_ln878_100_fu_172_p2 = ((p_V_reg_114 == 2'd2) ? 1'b1 : 1'b0);
