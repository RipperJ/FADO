...
wire   [0:0] icmp_ln878_66_fu_165_p2;
reg   [5:0] ap_NS_fsm;
wire    ap_ce_reg;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        v2_V_1607_reg_233 <= mem_data_split_V_q0;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln878_66_fu_165_p2 == 1'd1))) begin
...
assign D_d0 = {{{{mem_data_split_V_q1}, {mem_data_split_V_q0}}, {v2_V_1607_reg_233}}, {v2_V_reg_228}};
...
assign icmp_ln878_66_fu_165_p2 = ((p_V_reg_132 == 3'd4) ? 1'b1 : 1'b0);
