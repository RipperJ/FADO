...
set C_modelArgList {
	{ fifo_B_B_IO_L3_in_serialize_x12 int 256 regular {fifo 1 volatile }  }
	{ B int 512 regular {array 1024 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fifo_B_B_IO_L3_in_serialize_x12", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ fifo_B_B_IO_L3_in_serialize_x12_din sc_out sc_lv 256 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_B_B_IO_L3_in_serialize_x12_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "fifo_B_B_IO_L3_in_serialize_x12", "role": "din" }} , 
...
set Spec2ImplPortList { 
	fifo_B_B_IO_L3_in_serialize_x12 { ap_fifo {  { fifo_B_B_IO_L3_in_serialize_x12_din fifo_data 1 256 }  { fifo_B_B_IO_L3_in_serialize_x12_full_n fifo_status 0 1 }  { fifo_B_B_IO_L3_in_serialize_x12_write fifo_update 1 1 } } }
	B { ap_memory {  { B_address0 mem_address 1 10 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 512 } } }
}
