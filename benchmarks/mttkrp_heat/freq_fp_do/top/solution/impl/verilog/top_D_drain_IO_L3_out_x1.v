...
wire   [2:0] select_ln25836_fu_158_p3;
reg   [2:0] select_ln25836_reg_226;
wire   [0:0] icmp_ln890_fu_146_p2;
wire   [5:0] add_i_i56_cast_fu_174_p2;
reg   [5:0] add_i_i56_cast_reg_231;
wire   [0:0] icmp_ln25840_fu_180_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state4))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((icmp_ln886_fu_196_p2 == 1'd0) & (icmp_ln25840_fu_180_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & ((icmp_ln886_fu_196_p2 == 1'd1) | (icmp_ln25840_fu_180_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_196_p2 == 1'd0) & (icmp_ln25840_fu_180_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign add_ln691_fu_201_p2 = (select_ln25836_reg_226 + 3'd1);
...
assign icmp_ln25840_fu_180_p2 = ((c3_reg_118 == 4'd8) ? 1'b1 : 1'b0);
...
assign p_shl_fu_166_p3 = {{select_ln25836_fu_158_p3}, {3'd0}};

assign select_ln25836_fu_158_p3 = ((icmp_ln89022_fu_152_p2[0:0] == 1'b1) ? 3'd0 : c1_V_reg_107);
