...
wire   [2:0] select_ln11565_fu_187_p3;
reg   [2:0] select_ln11565_reg_275;
...
wire   [0:0] icmp_ln11574_fu_226_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state4))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((tmp_fu_209_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln11574_fu_226_p2 == 1'd0) & (icmp_ln886_fu_221_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state7))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((tmp_fu_209_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln11574_fu_226_p2 == 1'd1) & (icmp_ln886_fu_221_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_209_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln11574_fu_226_p2 == 1'd1) & (icmp_ln886_fu_221_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_209_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln11574_fu_226_p2 == 1'd0) & (icmp_ln886_fu_221_p2 == 1'd0))) begin
...
assign add_ln691_fu_232_p2 = (select_ln11565_reg_275 + 3'd1);
...
assign icmp_ln11574_fu_226_p2 = ((c3_reg_135 == 4'd6) ? 1'b1 : 1'b0);
...
assign p_shl_fu_195_p3 = {{select_ln11565_fu_187_p3}, {3'd0}};

assign select_ln11565_fu_187_p3 = ((icmp_ln89044_fu_181_p2[0:0] == 1'b1) ? 3'd0 : c1_V_reg_124);
