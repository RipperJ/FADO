...
wire   [2:0] add_ln691_457_fu_223_p2;
reg   [2:0] add_ln691_457_reg_358;
wire    ap_CS_fsm_state3;
wire   [5:0] add_i_i100_cast_fu_243_p2;
reg   [5:0] add_i_i100_cast_reg_366;
wire   [0:0] icmp_ln890_522_fu_229_p2;
wire   [0:0] icmp_ln25695_fu_266_p2;
reg   [0:0] icmp_ln25695_reg_377;
wire    ap_CS_fsm_state4;
wire   [0:0] tmp_fu_249_p3;
wire   [0:0] icmp_ln886_fu_261_p2;
wire   [2:0] add_ln691_459_fu_272_p2;
reg   [2:0] add_ln691_459_reg_381;
wire    ap_CS_fsm_state5;
wire   [2:0] add_ln691_458_fu_284_p2;
reg   [2:0] add_ln691_458_reg_389;
wire   [3:0] c3_13_fu_296_p2;
wire   [0:0] icmp_ln890_523_fu_290_p2;
wire   [0:0] icmp_ln890_524_fu_278_p2;
wire   [4:0] add_ln691_462_fu_302_p2;
reg   [4:0] add_ln691_462_reg_402;
wire    ap_CS_fsm_state6;
wire   [1:0] add_ln691_463_fu_314_p2;
reg   [1:0] add_ln691_463_reg_410;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_460_fu_326_p2;
reg   [4:0] add_ln691_460_reg_418;
wire    ap_CS_fsm_state9;
wire   [1:0] add_ln691_461_fu_338_p2;
reg   [1:0] add_ln691_461_reg_426;
...
wire   [0:0] icmp_ln890_526_fu_308_p2;
reg   [2:0] c4_V_reg_156;
wire   [0:0] icmp_ln890_525_fu_332_p2;
reg   [4:0] c5_V_11_reg_167;
wire   [0:0] icmp_ln890_528_fu_320_p2;
reg   [1:0] c6_V_75_reg_178;
reg    ap_block_state8;
reg   [4:0] c5_V_reg_189;
wire   [0:0] icmp_ln890_527_fu_344_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_111 <= 3'd0;
    end else if (((icmp_ln890_522_fu_229_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_217_p2 == 1'd0))) begin
        ...
        c1_V_reg_122 <= add_ln691_457_reg_358;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln25695_reg_377 == 1'd0) & (icmp_ln890_524_fu_278_p2 == 1'd1)) | ((icmp_ln25695_reg_377 == 1'd1) & (icmp_ln890_523_fu_290_p2 == 1'd1))))) begin
        c3_reg_133 <= c3_13_fu_296_p2;
    end else if (((icmp_ln890_522_fu_229_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c3_reg_133 <= 4'd1;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_526_fu_308_p2 == 1'd1))) begin
        c4_V_11_reg_145 <= add_ln691_459_reg_381;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_261_p2 == 1'd0) & (tmp_fu_249_p3 == 1'd0) & (icmp_ln25695_fu_266_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c4_V_reg_156 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_525_fu_332_p2 == 1'd1))) begin
        c4_V_reg_156 <= add_ln691_458_reg_389;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln25695_reg_377 == 1'd0) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_524_fu_278_p2 == 1'd0))) begin
        c5_V_11_reg_167 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_528_fu_320_p2 == 1'd1))) begin
        c5_V_11_reg_167 <= add_ln691_462_reg_402;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln25695_reg_377 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_523_fu_290_p2 == 1'd0))) begin
        c5_V_reg_189 <= 5'd0;
    end else if (((icmp_ln890_527_fu_344_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
        c5_V_reg_189 <= add_ln691_460_reg_418;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_526_fu_308_p2 == 1'd0))) begin
        ...
        c6_V_75_reg_178 <= add_ln691_463_reg_410;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_525_fu_332_p2 == 1'd0))) begin
        c6_V_reg_200 <= 2'd0;
        ...
        c6_V_reg_200 <= add_ln691_461_reg_426;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln890_522_fu_229_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_457_reg_358 <= add_ln691_457_fu_223_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln25695_reg_377 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        add_ln691_458_reg_389 <= add_ln691_458_fu_284_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln25695_reg_377 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        add_ln691_459_reg_381 <= add_ln691_459_fu_272_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        add_ln691_460_reg_418 <= add_ln691_460_fu_326_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        add_ln691_461_reg_426 <= add_ln691_461_fu_338_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_462_reg_402 <= add_ln691_462_fu_302_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        add_ln691_463_reg_410 <= add_ln691_463_fu_314_p2;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_522_fu_229_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln25695_reg_377 == 1'd0) & (icmp_ln890_524_fu_278_p2 == 1'd1)) | ((icmp_ln25695_reg_377 == 1'd1) & (icmp_ln890_523_fu_290_p2 == 1'd1))))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if (((icmp_ln25695_reg_377 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_523_fu_290_p2 == 1'd0))) begin
        ...
        ap_ST_fsm_state6 : begin
            if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_526_fu_308_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
        ...
        ap_ST_fsm_state7 : begin
            if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_528_fu_320_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_525_fu_332_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
        ...
        ap_ST_fsm_state10 : begin
            if (((icmp_ln890_527_fu_344_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else begin
...
assign add_ln691_457_fu_223_p2 = (c1_V_reg_122 + 3'd1);

assign add_ln691_458_fu_284_p2 = (c4_V_reg_156 + 3'd1);

assign add_ln691_459_fu_272_p2 = (c4_V_11_reg_145 + 3'd1);

assign add_ln691_460_fu_326_p2 = (c5_V_reg_189 + 5'd1);

assign add_ln691_461_fu_338_p2 = (c6_V_reg_200 + 2'd1);

assign add_ln691_462_fu_302_p2 = (c5_V_11_reg_167 + 5'd1);

assign add_ln691_463_fu_314_p2 = (c6_V_75_reg_178 + 2'd1);
...
assign icmp_ln890_522_fu_229_p2 = ((c1_V_reg_122 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln890_523_fu_290_p2 = ((c4_V_reg_156 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln890_524_fu_278_p2 = ((c4_V_11_reg_145 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln890_525_fu_332_p2 = ((c5_V_reg_189 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_526_fu_308_p2 = ((c5_V_11_reg_167 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln890_527_fu_344_p2 = ((c6_V_reg_200 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln890_528_fu_320_p2 = ((c6_V_75_reg_178 == 2'd2) ? 1'b1 : 1'b0);
