...
wire   [2:0] add_ln691_1638_fu_161_p2;
reg   [2:0] add_ln691_1638_reg_240;
wire    ap_CS_fsm_state3;
wire   [5:0] add_i_i35_cast_fu_181_p2;
reg   [5:0] add_i_i35_cast_reg_248;
wire   [0:0] icmp_ln890_1582_fu_167_p2;
wire   [7:0] c2_V_179_fu_187_p2;
reg   [7:0] c2_V_179_reg_253;
wire    ap_CS_fsm_state4;
wire   [3:0] c3_62_fu_205_p2;
reg   [3:0] c3_62_reg_264;
wire    ap_CS_fsm_state5;
wire   [1:0] add_ln691_1640_fu_220_p2;
reg   [1:0] add_ln691_1640_reg_272;
...
reg   [3:0] c3_reg_127;
wire   [0:0] icmp_ln890_1583_fu_226_p2;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        c0_V_reg_94 <= 3'd0;
    end else if (((icmp_ln890_1582_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((icmp_ln890_1582_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        c2_V_reg_116 <= 8'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_1583_fu_226_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln890_1582_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((icmp_ln890_1582_fu_167_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
...
assign add_ln691_1638_fu_161_p2 = (c1_V_reg_105 + 3'd1);

assign add_ln691_1640_fu_220_p2 = (c4_V_reg_138 + 2'd1);
...
assign c2_V_179_fu_187_p2 = (c2_V_reg_116 + 8'd1);
...
assign icmp_ln890_1582_fu_167_p2 = ((c1_V_reg_105 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln890_1583_fu_226_p2 = ((c4_V_reg_138 == 2'd2) ? 1'b1 : 1'b0);
