...
wire   [2:0] add_ln691_478_fu_222_p2;
reg   [2:0] add_ln691_478_reg_355;
...
wire   [0:0] icmp_ln11910_fu_269_p2;
reg   [0:0] icmp_ln11910_reg_379;
wire   [0:0] icmp_ln11905_fu_248_p2;
wire   [0:0] icmp_ln886_fu_264_p2;
wire   [2:0] add_ln691_480_fu_275_p2;
reg   [2:0] add_ln691_480_reg_383;
wire    ap_CS_fsm_state5;
wire   [2:0] add_ln691_479_fu_287_p2;
reg   [2:0] add_ln691_479_reg_391;
wire   [4:0] add_ln691_483_fu_299_p2;
reg   [4:0] add_ln691_483_reg_399;
wire    ap_CS_fsm_state6;
wire   [1:0] add_ln691_484_fu_311_p2;
reg   [1:0] add_ln691_484_reg_407;
wire    ap_CS_fsm_state7;
wire   [4:0] add_ln691_481_fu_323_p2;
reg   [4:0] add_ln691_481_reg_415;
wire    ap_CS_fsm_state9;
wire   [1:0] add_ln691_482_fu_335_p2;
reg   [1:0] add_ln691_482_reg_423;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_216_p2 == 1'd0))) begin
        c1_V_reg_122 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_fu_264_p2 == 1'd1) | (icmp_ln11905_fu_248_p2 == 1'd1)))) begin
        c1_V_reg_122 <= add_ln691_478_reg_355;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln11910_reg_379 == 1'd1) & (icmp_ln890_544_fu_293_p2 == 1'd1)) | ((icmp_ln11910_reg_379 == 1'd0) & (icmp_ln890_545_fu_281_p2 == 1'd1))))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_264_p2 == 1'd0) & (icmp_ln11905_fu_248_p2 == 1'd0) & (icmp_ln11910_fu_269_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        c4_V_14_reg_144 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_547_fu_305_p2 == 1'd1))) begin
        c4_V_14_reg_144 <= add_ln691_480_reg_383;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_264_p2 == 1'd0) & (icmp_ln11905_fu_248_p2 == 1'd0) & (icmp_ln11910_fu_269_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        c4_V_reg_155 <= 3'd0;
    end else if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_546_fu_329_p2 == 1'd1))) begin
        c4_V_reg_155 <= add_ln691_479_reg_391;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln11910_reg_379 == 1'd0) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_545_fu_281_p2 == 1'd0))) begin
        c5_V_14_reg_166 <= 5'd0;
    end else if (((1'b1 == ap_CS_fsm_state7) & (icmp_ln890_549_fu_317_p2 == 1'd1))) begin
        c5_V_14_reg_166 <= add_ln691_483_reg_399;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln11910_reg_379 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_544_fu_293_p2 == 1'd0))) begin
        c5_V_reg_188 <= 5'd0;
    end else if (((icmp_ln890_548_fu_341_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
        c5_V_reg_188 <= add_ln691_481_reg_415;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln890_547_fu_305_p2 == 1'd0))) begin
        ...
        c6_V_78_reg_177 <= add_ln691_484_reg_407;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & (icmp_ln890_546_fu_329_p2 == 1'd0))) begin
        ...
        c6_V_reg_199 <= add_ln691_482_reg_423;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_478_reg_355 <= add_ln691_478_fu_222_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln11910_reg_379 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        add_ln691_479_reg_391 <= add_ln691_479_fu_287_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln11910_reg_379 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        add_ln691_480_reg_383 <= add_ln691_480_fu_275_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        add_ln691_481_reg_415 <= add_ln691_481_fu_323_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        add_ln691_482_reg_423 <= add_ln691_482_fu_335_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_483_reg_399 <= add_ln691_483_fu_299_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        add_ln691_484_reg_407 <= add_ln691_484_fu_311_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln886_fu_264_p2 == 1'd0) & (icmp_ln11905_fu_248_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & ((icmp_ln886_fu_264_p2 == 1'd1) | (icmp_ln11905_fu_248_p2 == 1'd1)))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (((icmp_ln11910_reg_379 == 1'd1) & (icmp_ln890_544_fu_293_p2 == 1'd1)) | ((icmp_ln11910_reg_379 == 1'd0) & (icmp_ln890_545_fu_281_p2 == 1'd1))))) begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end else if (((icmp_ln11910_reg_379 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (icmp_ln890_544_fu_293_p2 == 1'd0))) begin
...
assign add_ln691_478_fu_222_p2 = (c1_V_reg_122 + 3'd1);

assign add_ln691_479_fu_287_p2 = (c4_V_reg_155 + 3'd1);

assign add_ln691_480_fu_275_p2 = (c4_V_14_reg_144 + 3'd1);

assign add_ln691_481_fu_323_p2 = (c5_V_reg_188 + 5'd1);

assign add_ln691_482_fu_335_p2 = (c6_V_reg_199 + 2'd1);

assign add_ln691_483_fu_299_p2 = (c5_V_14_reg_166 + 5'd1);

assign add_ln691_484_fu_311_p2 = (c6_V_78_reg_177 + 2'd1);
...
assign icmp_ln11905_fu_248_p2 = ((c3_reg_133 == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln11910_fu_269_p2 = ((c3_reg_133 == 4'd0) ? 1'b1 : 1'b0);
