...
wire   [2:0] add_ln691_1635_fu_161_p2;
reg   [2:0] add_ln691_1635_reg_240;
...
wire   [1:0] add_ln691_1637_fu_220_p2;
reg   [1:0] add_ln691_1637_reg_272;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln890_fu_155_p2 == 1'd0))) begin
        ...
        c1_V_reg_105 <= add_ln691_1635_reg_240;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln14866_fu_199_p2 == 1'd0) & (icmp_ln886_fu_215_p2 == 1'd0))) begin
        ...
        c4_V_reg_138 <= add_ln691_1637_reg_272;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        add_ln691_1635_reg_240 <= add_ln691_1635_fu_161_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        add_ln691_1637_reg_272 <= add_ln691_1637_fu_220_p2;
    end
end
...
assign add_ln691_1635_fu_161_p2 = (c1_V_reg_105 + 3'd1);

assign add_ln691_1637_fu_220_p2 = (c4_V_reg_138 + 2'd1);
