...
set portList { 
	...
	{ xin_address0 sc_out sc_lv 12 signal 2 } 
	{ xin_ce0 sc_out sc_logic 1 signal 2 } 
	{ xin_we0 sc_out sc_logic 1 signal 2 } 
	{ xin_d0 sc_out sc_lv 119 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128ns_130ns_257_5_1_U11", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128s_128s_128_5_1_U12", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2183882", "Max" : "2183882"}
	, {"Name" : "Interval", "Min" : "2183882", "Max" : "2183882"}
]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "557409", "EstimateLatencyMax" : "557409",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cov_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128s_128s_128_5_1_U11", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_128ns_130ns_257_5_1_U12", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	nondf_kernel_cov_x1 {
		gmem_B {Type I LastRead 72 FirstWrite -1}
		xout {Type I LastRead 0 FirstWrite -1}
		xin {Type O LastRead -1 FirstWrite 89}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "557409", "Max" : "557409"}
	, {"Name" : "Interval", "Min" : "557409", "Max" : "557409"}
]}
