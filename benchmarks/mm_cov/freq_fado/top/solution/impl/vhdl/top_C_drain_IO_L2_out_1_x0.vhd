...
attribute shreg_extract : string;
    ...
    signal add_ln691_170_fu_173_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln691_170_reg_259 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal icmp_ln890_231_fu_185_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_174_fu_197_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_174_reg_274 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal add_ln691_172_fu_209_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_172_reg_282 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_171_fu_221_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln890_232_fu_215_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln890_233_fu_203_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln691_175_fu_227_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_175_reg_295 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal add_ln691_173_fu_239_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln691_173_reg_303 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal c0_V_reg_83 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln890_230_fu_179_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln890_235_fu_233_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal c4_V_reg_128 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln890_234_fu_245_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_230_fu_179_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln890_231_fu_185_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state5) and (((icmp_ln890_232_fu_215_p2 = ap_const_lv1_1) and (icmp_ln870_reg_270 = ap_const_lv1_1)) or ((icmp_ln870_reg_270 = ap_const_lv1_0) and (icmp_ln890_233_fu_203_p2 = ap_const_lv1_1))))) then 
                c3_V_reg_105 <= add_ln691_171_fu_221_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_230_fu_179_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_231_fu_185_p2 = ap_const_lv1_0) and (icmp_ln870_fu_191_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                c4_V_6_reg_117 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_235_fu_233_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_231_fu_185_p2 = ap_const_lv1_0) and (icmp_ln870_fu_191_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                c4_V_reg_128 <= ap_const_lv4_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_234_fu_245_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln870_reg_270 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5) and (icmp_ln890_233_fu_203_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_232_fu_215_p2 = ap_const_lv1_0) and (icmp_ln870_reg_270 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln890_231_fu_185_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                icmp_ln870_reg_270 <= icmp_ln870_fu_191_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, fifo_C_drain_C_drain_IO_L2_out_2_x0294_empty_n, fifo_C_drain_C_drain_IO_L2_out_1_x0293_full_n, fifo_C_drain_C_drain_IO_L1_out_1_0_x0236_empty_n, ap_CS_fsm_state7, ap_CS_fsm_state9, ap_CS_fsm_state2, ap_CS_fsm_state3, icmp_ln870_reg_270, ap_CS_fsm_state4, icmp_ln890_231_fu_185_p2, ap_CS_fsm_state5, icmp_ln890_232_fu_215_p2, icmp_ln890_233_fu_203_p2, ap_CS_fsm_state6, ap_CS_fsm_state8, icmp_ln890_230_fu_179_p2, icmp_ln890_fu_167_p2, icmp_ln890_235_fu_233_p2, icmp_ln890_234_fu_245_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln890_230_fu_179_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
            when ap_ST_fsm_state4 => 
                if (((icmp_ln890_231_fu_185_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state5) and (((icmp_ln890_232_fu_215_p2 = ap_const_lv1_1) and (icmp_ln870_reg_270 = ap_const_lv1_1)) or ((icmp_ln870_reg_270 = ap_const_lv1_0) and (icmp_ln890_233_fu_203_p2 = ap_const_lv1_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                elsif (((icmp_ln890_232_fu_215_p2 = ap_const_lv1_0) and (icmp_ln870_reg_270 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                else
                    ap_NS_fsm <= ap_ST_fsm_state6;
                end if;
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (icmp_ln890_235_fu_233_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
            ...
            when ap_ST_fsm_state8 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state8) and (icmp_ln890_234_fu_245_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state5;
                else
    ...
    add_ln691_170_fu_173_p2 <= std_logic_vector(unsigned(c1_V_reg_94) + unsigned(ap_const_lv5_1));
    add_ln691_171_fu_221_p2 <= std_logic_vector(unsigned(c3_V_reg_105) + unsigned(ap_const_lv4_1));
    add_ln691_172_fu_209_p2 <= std_logic_vector(unsigned(c4_V_reg_128) + unsigned(ap_const_lv4_1));
    add_ln691_173_fu_239_p2 <= std_logic_vector(unsigned(c5_V_reg_150) + unsigned(ap_const_lv4_1));
    add_ln691_174_fu_197_p2 <= std_logic_vector(unsigned(c4_V_6_reg_117) + unsigned(ap_const_lv4_1));
    add_ln691_175_fu_227_p2 <= std_logic_vector(unsigned(c5_V_6_reg_139) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln890_230_fu_179_p2 <= "1" when (c1_V_reg_94 = ap_const_lv5_10) else "0";
    icmp_ln890_231_fu_185_p2 <= "1" when (c3_V_reg_105 = ap_const_lv4_8) else "0";
    icmp_ln890_232_fu_215_p2 <= "1" when (c4_V_reg_128 = ap_const_lv4_8) else "0";
    icmp_ln890_233_fu_203_p2 <= "1" when (c4_V_6_reg_117 = ap_const_lv4_8) else "0";
    icmp_ln890_234_fu_245_p2 <= "1" when (c5_V_reg_150 = ap_const_lv4_8) else "0";
    icmp_ln890_235_fu_233_p2 <= "1" when (c5_V_6_reg_139 = ap_const_lv4_8) else "0";
