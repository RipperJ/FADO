...
wire   [12:0] i_V_3_fu_61_p2;
reg   [12:0] i_V_3_reg_82;
...
always @ (posedge ap_clk) begin
    if (((fifo_A_A_IO_L3_in_serialize_x01_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign fifo_A_A_IO_L3_in_serialize_x01_din = A_load_reg_95;

assign i_V_3_fu_61_p2 = (i_V_reg_50 + 13'd1);
