...
reg    C_blk_n;
reg   [12:0] i_V_reg_100;
reg   [57:0] trunc_ln_reg_152;
wire   [12:0] i_V_1_fu_131_p2;
reg   [12:0] i_V_1_reg_163;
...
reg   [127:0] v2_V_7747_reg_177;
reg    ap_block_state5_pp0_stage2_iter0;
reg    ap_block_pp0_stage2_11001;
reg   [127:0] v2_V_7748_reg_182;
...
reg   [12:0] ap_phi_mux_i_V_phi_fu_104_p4;
wire  signed [63:0] sext_ln17587_fu_121_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((m_axi_gmem_C_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((m_axi_gmem_C_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln878_reg_168 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln878_reg_168 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0)));
end

assign ap_block_pp0_stage2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage2_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage2_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

assign ap_block_pp0_stage3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage3_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage3_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage1_iter0 = ((icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage2_iter0 = ((icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state6_pp0_stage3_iter0 = ((icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter1 = ((icmp_ln878_reg_168 == 1'd0) & (fifo_C_drain_local_in_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state8_io = ((icmp_ln878_reg_168_pp0_iter1_reg == 1'd0) & (m_axi_gmem_C_WREADY == 1'b0));
end
...
assign i_V_1_fu_131_p2 = (ap_phi_mux_i_V_phi_fu_104_p4 + 13'd1);

assign icmp_ln878_fu_137_p2 = ((ap_phi_mux_i_V_phi_fu_104_p4 == 13'd4096) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_C_AWADDR = sext_ln17587_fu_121_p1;
...
assign m_axi_gmem_C_WDATA = {{{{v1_V_reg_187}, {v2_V_7748_reg_182}}, {v2_V_7747_reg_177}}, {v2_V_reg_172}};
...
assign sext_ln17587_fu_121_p1 = $signed(trunc_ln_reg_152);
