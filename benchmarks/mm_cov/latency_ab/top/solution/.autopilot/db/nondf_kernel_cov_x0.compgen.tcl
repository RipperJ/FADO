...
set id 1
set name top_mul_128ns_130ns_257_5_1
...
set id 2
set name top_mul_128s_128s_128_5_1
set corename simcore_mul
set op mul
set stage_num 5
set max_latency -1
...
set ID 5
set hasByteEnable 0
set MemName top_nondf_kernel_cov_x0_mean_V
...
set ID 6
set hasByteEnable 0
set MemName top_nondf_kernel_cov_x0_data_V
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 128
set AddrRange 4096
...
set ID 7
set hasByteEnable 0
set MemName top_nondf_kernel_cov_x0_cov_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 119
set AddrRange 4096
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename xin \
    op interface \
    ports { xin_address0 { O 12 vector } xin_ce0 { O 1 bit } xin_we0 { O 1 bit } xin_d0 { O 119 vector } } \
} "
} else {
